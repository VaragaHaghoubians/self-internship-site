...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/IPython/__main__.py</div>
    </header>
    ...
    <script>
      const readerCode = "# PYTHON_ARGCOMPLETE_OK\n# encoding: utf-8\n\"\"\"Terminal-based IPython entry point.\"\"\"\n# -----------------------------------------------------------------------------\n#  Copyright (c) 2012, IPython Development Team.\n#\n#  Distributed under the terms of the Modified BSD License.\n#\n#  The full license is in the file COPYING.txt, distributed with this software.\n# -----------------------------------------------------------------------------\n\nfrom IPython import start_ipython\n\nstart_ipython()\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/IPython/__main__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># PYTHON_ARGCOMPLETE_OK
# encoding: utf-8
&quot;&quot;&quot;Terminal-based IPython entry point.&quot;&quot;&quot;
# -----------------------------------------------------------------------------
#  Copyright (c) 2012, IPython Development Team.
