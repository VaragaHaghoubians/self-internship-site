...
<html lang="en">
  <head>
    ...
    <title>Glut.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/IPython/terminal/pt_inputhooks/glut.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;GLUT Input hook for interactive use with prompt_toolkit
&quot;&quot;&quot;
