...
<html lang="en">
  <head>
    ...
    <title>Gtk3.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/IPython/terminal/pt_inputhooks/gtk3.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"prompt_toolkit input hook for GTK 3\"\"\"\n\nfrom gi.repository import Gtk, GLib\n\n\ndef _main_quit(*args, **kwargs):\n    Gtk.main_quit()\n    return False\n\n\ndef inputhook(context):\n    GLib.io_add_watch(context.fileno(), GLib.PRIORITY_DEFAULT, GLib.IO_IN, _main_quit)\n    Gtk.main()\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/IPython/terminal/pt_inputhooks/gtk3.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;prompt_toolkit input hook for GTK 3&quot;&quot;&quot;
