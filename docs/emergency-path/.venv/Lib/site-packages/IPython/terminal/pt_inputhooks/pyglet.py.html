...
<html lang="en">
  <head>
    ...
    <title>Pyglet.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/IPython/terminal/pt_inputhooks/pyglet.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Enable pyglet to be used interactively with prompt_toolkit&quot;&quot;&quot;
