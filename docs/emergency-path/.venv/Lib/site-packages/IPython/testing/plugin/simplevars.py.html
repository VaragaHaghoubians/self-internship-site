...
<html lang="en">
  <head>
    ...
    <title>Simplevars.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/IPython/testing/plugin/simplevars.py</div>
    </header>
    ...
    <script>
      const readerCode = "x = 1\nprint(\"x is:\", x)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/IPython/testing/plugin/simplevars.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>x = 1
print(&quot;x is:&quot;, x)
</code></pre></article>
