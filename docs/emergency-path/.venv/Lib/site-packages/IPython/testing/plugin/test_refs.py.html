...
<html lang="en">
  <head>
    ...
    <title>Test Refs.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/IPython/testing/plugin/test_refs.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Some simple tests for the plugin while running scripts.
&quot;&quot;&quot;
# Module imports
# Std lib
import inspect
