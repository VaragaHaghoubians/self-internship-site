...
<html lang="en">
  <head>
    ...
    <title> Process Emscripten.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1> Process Emscripten.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/IPython/utils/_process_emscripten.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Emscripten-specific implementation of process utilities.\n\nThis file is only meant to be imported by process.py, not by end-users.\n\"\"\"\n\nfrom ._process_common import arg_split\n\n\ndef system(cmd):\n    raise OSError(\"Not available\")\n\n\ndef getoutput(cmd):\n    raise OSError(\"Not available\")\n\n\ndef check_pid(cmd):\n    raise OSError(\"Not available\")\n\n\n# `arg_split` is still used by magics regardless of whether we are on a posix/windows/emscipten\n__all__ = [\"system\", \"getoutput\", \"check_pid\", \"arg_split\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/IPython/utils/_process_emscripten.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Emscripten-specific implementation of process utilities.
