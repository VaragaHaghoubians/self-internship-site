...
<html lang="en">
  <head>
    ...
    <title> Sysinfo.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/IPython/utils/_sysinfo.py</div>
    </header>
    ...
    <script>
      const readerCode = "# GENERATED BY setup.py\ncommit = \"d9c6e31\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/IPython/utils/_sysinfo.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># GENERATED BY setup.py
commit = &quot;d9c6e31&quot;
</code></pre></article>
