...
<html lang="en">
  <head>
    ...
    <title>Coloransi.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/IPython/utils/coloransi.py</div>
    </header>
    ...
    <script>
      const readerCode = "# Deprecated/should be removed, but we break older version of ipyparallel\n# https://github.com/ipython/ipyparallel/pull/924\n\n\n# minimal subset of TermColors, removed from IPython\n# not for public consumption, beyond ipyparallel.\nclass TermColors:\n    Normal = \"\\033[0m\"\n    Red = \"\\033[0;31m\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/IPython/utils/coloransi.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Deprecated/should be removed, but we break older version of ipyparallel
# https://github.com/ipython/ipyparallel/pull/924
