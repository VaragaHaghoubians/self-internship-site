...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/PIL/_version.py</div>
    </header>
    ...
    <script>
      const readerCode = "# Master version for Pillow\nfrom __future__ import annotations\n\n__version__ = \"12.2.0\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/PIL/_version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Master version for Pillow
from __future__ import annotations
