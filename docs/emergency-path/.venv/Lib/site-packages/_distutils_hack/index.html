...
<html lang="en">
  <head>
    ...
    <title>_distutils_hack - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>_distutils_hack</h1>
      <p>Clean index for this workspace folder.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/_distutils_hack</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="__init__.py.html"><strong>__init__.py</strong><span>emergency-path/.venv/Lib/site-packages/_distutils_hack/__init__.py</span></a><a class="dir-item" href="override.py.html"><strong>override.py</strong><span>emergency-path/.venv/Lib/site-packages/_distutils_hack/override.py</span></a></div></article>
