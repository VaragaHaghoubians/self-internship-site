...
<html lang="en">
  <head>
    ...
    <title>Override.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/_distutils_hack/override.py</div>
    </header>
    ...
    <script>
      const readerCode = "__import__('_distutils_hack').do_override()\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/_distutils_hack/override.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__import__(&#x27;_distutils_hack&#x27;).do_override()
</code></pre></article>
