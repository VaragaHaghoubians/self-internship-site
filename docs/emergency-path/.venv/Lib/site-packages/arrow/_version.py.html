...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/arrow/_version.py</div>
    </header>
    ...
    <script>
      const readerCode = "__version__ = \"1.4.0\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/arrow/_version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__version__ = &quot;1.4.0&quot;
</code></pre></article>
