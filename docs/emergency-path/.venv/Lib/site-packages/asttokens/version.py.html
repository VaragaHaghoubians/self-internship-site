...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/asttokens/version.py</div>
    </header>
    ...
    <script>
      const readerCode = "__version__ = \"3.0.1\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/asttokens/version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__version__ = &quot;3.0.1&quot;
</code></pre></article>
