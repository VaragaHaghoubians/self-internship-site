...
<html lang="en">
  <head>
    ...
    <title>Callbacks.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/bleach/callbacks.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;A set of basic callbacks for bleach.linkify.&quot;&quot;&quot;
