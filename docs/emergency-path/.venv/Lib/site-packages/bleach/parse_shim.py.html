...
<html lang="en">
  <head>
    ...
    <title>Parse Shim.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/bleach/parse_shim.py</div>
    </header>
    ...
    <script>
      const readerCode = "from bleach._vendor.parse import urlparse  # noqa\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/bleach/parse_shim.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from bleach._vendor.parse import urlparse  # noqa
</code></pre></article>
