...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/dateutil/_version.py</div>
    </header>
    ...
    <script>
      const readerCode = "# file generated by setuptools_scm\n# don't change, don't track in version control\n__version__ = version = '2.9.0.post0'\n__version_tuple__ = version_tuple = (2, 9, 0)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/dateutil/_version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># file generated by setuptools_scm
# don&#x27;t change, don&#x27;t track in version control
__version__ = version = &#x27;2.9.0.post0&#x27;
__version_tuple__ = version_tuple = (2, 9, 0)
</code></pre></article>
