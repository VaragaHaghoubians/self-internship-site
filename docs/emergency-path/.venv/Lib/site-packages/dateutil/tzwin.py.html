...
<html lang="en">
  <head>
    ...
    <title>Tzwin.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/dateutil/tzwin.py</div>
    </header>
    ...
    <script>
      const readerCode = "# tzwin has moved to dateutil.tz.win\nfrom .tz.win import *\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/dateutil/tzwin.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># tzwin has moved to dateutil.tz.win
from .tz.win import *
</code></pre></article>
