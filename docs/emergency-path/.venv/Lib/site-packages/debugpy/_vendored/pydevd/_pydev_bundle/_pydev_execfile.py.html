...
<html lang="en">
  <head>
    ...
    <title> Pydev Execfile.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1> Pydev Execfile.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/_pydev_bundle/_pydev_execfile.py</div>
    </header>
    ...
    <script>
      const readerCode = "# We must redefine it in Py3k if it's not already there\ndef execfile(file, glob=None, loc=None):\n    if glob is None:\n        import sys\n\n        glob = sys._getframe().f_back.f_globals\n    if loc is None:\n        loc = glob\n\n    import tokenize\n\n    with tokenize.open(file) as stream:\n        contents = stream.read()\n\n    # execute the script (note: it's important to compile first to have the filename set in debug mode)\n    exec(compile(contents + \"\\n\", file, \"exec\"), glob, loc)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/_pydev_bundle/_pydev_execfile.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># We must redefine it in Py3k if it&#x27;s not already there
def execfile(file, glob=None, loc=None):
    if glob is None:
        import sys
