...
<html lang="en">
  <head>
    ...
    <title> Pydev Sys Patch.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1> Pydev Sys Patch.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/_pydev_bundle/_pydev_sys_patch.py</div>
    </header>
    ...
    <script>
      ...
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/_pydev_bundle/_pydev_sys_patch.py";
