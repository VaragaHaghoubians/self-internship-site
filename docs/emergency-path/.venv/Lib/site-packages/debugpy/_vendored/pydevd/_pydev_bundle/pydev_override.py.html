...
<html lang="en">
  <head>
    ...
    <title>Pydev Override.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Pydev Override.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/_pydev_bundle/pydev_override.py</div>
    </header>
    ...
    <script>
      const readerCode = "def overrides(method):\n    \"\"\"\n    Meant to be used as\n\n    class B:\n        @overrides(A.m1)\n        def m1(self):\n            pass\n    \"\"\"\n\n    def wrapper(func):\n        if func.__name__ != method.__name__:\n            msg = \"Wrong @override: %r expected, but overwriting %r.\"\n            msg = msg % (func.__name__, method.__name__)\n            raise AssertionError(msg)\n\n        if func.__doc__ is None:\n            func.__doc__ = method.__doc__\n\n        return func\n\n    return wrapper\n\n\ndef implements(method):\n    def wrapper(func):\n        if func.__name__ != method.__name__:\n            msg = \"Wrong @implements: %r expected, but implementing %r.\"\n            msg = msg % (func.__name__, method.__name__)\n            raise AssertionError(msg)\n\n        if func.__doc__ is None:\n            func.__doc__ = method.__doc__\n\n        return func\n\n    return wrapper\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/_pydev_bundle/pydev_override.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>def overrides(method):
    &quot;&quot;&quot;
    Meant to be used as
