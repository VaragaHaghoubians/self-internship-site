...
<html lang="en">
  <head>
    ...
    <title>Pydevd Exec2.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Pydevd Exec2.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/_pydevd_bundle/pydevd_exec2.py</div>
    </header>
    ...
    <script>
      const readerCode = "def Exec(exp, global_vars, local_vars=None):\n    if local_vars is not None:\n        exec(exp, global_vars, local_vars)\n    else:\n        exec(exp, global_vars)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/_pydevd_bundle/pydevd_exec2.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>def Exec(exp, global_vars, local_vars=None):
    if local_vars is not None:
        exec(exp, global_vars, local_vars)
    else:
        exec(exp, global_vars)
