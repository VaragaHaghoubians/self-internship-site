...
<html lang="en">
  <head>
    ...
    <title>Readme.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/_pydevd_frame_eval/vendored/README.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>This folder contains vendored dependencies of the debugger.
...
Note: commit the egg-info as a note of the license (force if needed).</code></pre></article>
