...
<html lang="en">
  <head>
    ...
    <title>Pydev Pysrc.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Pydev Pysrc.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/pydev_pysrc.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"An empty file in pysrc that can be imported (from sitecustomize) to find the location of pysrc\"\"\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/pydev_pysrc.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;An empty file in pysrc that can be imported (from sitecustomize) to find the location of pysrc&quot;&quot;&quot;
</code></pre></article>
