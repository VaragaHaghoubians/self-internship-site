...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/pydevd_attach_to_process/README.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>This folder contains the utilities to attach a target process to the pydev debugger.
