...
<html lang="en">
  <head>
    ...
    <title> Check.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/pydevd_attach_to_process/_check.py</div>
    </header>
    ...
    <script>
      const readerCode = "import add_code_to_python_process\n\nprint(add_code_to_python_process.run_python_code(3736, \"print(20)\", connect_debugger_tracing=False))\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/pydevd_attach_to_process/_check.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>import add_code_to_python_process
