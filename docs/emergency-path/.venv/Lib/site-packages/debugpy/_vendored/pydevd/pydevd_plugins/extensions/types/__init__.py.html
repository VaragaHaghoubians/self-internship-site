...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/pydevd_plugins/extensions/types/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "import pkgutil\n\n__path__ = pkgutil.extend_path(__path__, __name__)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/debugpy/_vendored/pydevd/pydevd_plugins/extensions/types/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>import pkgutil
