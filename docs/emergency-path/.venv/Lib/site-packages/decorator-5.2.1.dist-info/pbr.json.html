...
<html lang="en">
  <head>
    ...
    <title>Pbr.Json - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/decorator-5.2.1.dist-info/pbr.json</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>{&quot;is_release&quot;: false, &quot;git_version&quot;: &quot;8608a46&quot;}</code></pre></article>
