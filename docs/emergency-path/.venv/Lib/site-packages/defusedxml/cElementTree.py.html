...
<html lang="en">
  <head>
    ...
    <title>Celementtree.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Celementtree.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/defusedxml/cElementTree.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># defusedxml
#
# Copyright (c) 2013 by Christian Heimes &lt;christian@python.org&gt;
# Licensed to PSF under a Contributor Agreement.
# See https://www.python.org/psf/license for licensing details.
