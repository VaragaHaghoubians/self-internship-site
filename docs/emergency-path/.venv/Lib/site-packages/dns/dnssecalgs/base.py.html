...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/dns/dnssecalgs/base.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from abc import ABC, abstractmethod  # pylint: disable=no-name-in-module
from typing import Any, Type
