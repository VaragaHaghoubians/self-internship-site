...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/executing/version.py</div>
    </header>
    ...
    <script>
      const readerCode = "__version__ = '2.2.1'";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/executing/version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__version__ = &#x27;2.2.1&#x27;</code></pre></article>
