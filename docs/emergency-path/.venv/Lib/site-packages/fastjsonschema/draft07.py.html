...
<html lang="en">
  <head>
    ...
    <title>Draft07.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fastjsonschema/draft07.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .draft06 import CodeGeneratorDraft06
