...
<html lang="en">
  <head>
    ...
    <title>Indent.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fastjsonschema/indent.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>def indent(func):
    &quot;&quot;&quot;
    Decorator for allowing to use method as normal method or with
    context manager for auto-indenting code blocks.
    &quot;&quot;&quot;
