...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fastjsonschema/version.py</div>
    </header>
    ...
    <script>
      const readerCode = "VERSION = '2.21.2'\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fastjsonschema/version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>VERSION = &#x27;2.21.2&#x27;
</code></pre></article>
