...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/colorLib/errors.py</div>
    </header>
    ...
    <script>
      const readerCode = "class ColorLibError(Exception):\n    pass\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/colorLib/errors.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>class ColorLibError(Exception):
    pass
</code></pre></article>
