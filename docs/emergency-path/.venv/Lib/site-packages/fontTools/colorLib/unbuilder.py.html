...
<html lang="en">
  <head>
    ...
    <title>Unbuilder.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/colorLib/unbuilder.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from fontTools.ttLib.tables import otTables as ot
from .table_builder import TableUnbuilder
