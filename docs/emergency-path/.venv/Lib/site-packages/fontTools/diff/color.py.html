...
<html lang="en">
  <head>
    ...
    <title>Color.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/diff/color.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from typing import Dict, Text
