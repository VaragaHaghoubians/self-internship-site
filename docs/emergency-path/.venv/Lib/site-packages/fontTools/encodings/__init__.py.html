...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/encodings/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Empty __init__.py file to signal Python this directory is a package.\"\"\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/encodings/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Empty __init__.py file to signal Python this directory is a package.&quot;&quot;&quot;
</code></pre></article>
