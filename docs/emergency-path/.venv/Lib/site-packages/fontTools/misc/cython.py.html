...
<html lang="en">
  <head>
    ...
    <title>Cython.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/misc/cython.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot; Exports a no-op &#x27;cython&#x27; namespace similar to
https://github.com/cython/cython/blob/master/Cython/Shadow.py
