...
<html lang="en">
  <head>
    ...
    <title>Enumtools.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/misc/enumTools.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Enum-related utilities, including backports for older Python versions.\"\"\"\n\nfrom __future__ import annotations\n\nfrom enum import Enum\n\n\n__all__ = [\"StrEnum\"]\n\n# StrEnum is only available in Python 3.11+\ntry:\n    from enum import StrEnum\nexcept ImportError:\n\n    class StrEnum(str, Enum):\n        \"\"\"\n        Minimal backport of Python 3.11's StrEnum for older versions.\n\n        An Enum where all members are also strings.\n        \"\"\"\n\n        def __str__(self) -> str:\n            return self.value\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/misc/enumTools.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Enum-related utilities, including backports for older Python versions.&quot;&quot;&quot;
