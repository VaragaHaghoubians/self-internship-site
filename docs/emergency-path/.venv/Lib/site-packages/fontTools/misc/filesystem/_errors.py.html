...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/misc/filesystem/_errors.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>class FSError(Exception):
    pass
