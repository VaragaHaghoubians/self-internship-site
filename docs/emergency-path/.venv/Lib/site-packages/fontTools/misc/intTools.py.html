...
<html lang="en">
  <head>
    ...
    <title>Inttools.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/misc/intTools.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__all__ = [&quot;popCount&quot;, &quot;bit_count&quot;, &quot;bit_indices&quot;]
