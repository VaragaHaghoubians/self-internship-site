...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/misc/iterTools.py</div>
    </header>
    ...
    <script>
      const readerCode = "from itertools import *\n\n# Python 3.12:\nif \"batched\" not in globals():\n    # https://docs.python.org/3/library/itertools.html#itertools.batched\n    def batched(iterable, n):\n        # batched('ABCDEFG', 3) --> ABC DEF G\n        if n < 1:\n            raise ValueError(\"n must be at least one\")\n        it = iter(iterable)\n        while batch := tuple(islice(it, n)):\n            yield batch\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/misc/iterTools.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from itertools import *
