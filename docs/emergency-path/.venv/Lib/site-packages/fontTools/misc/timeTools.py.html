...
<html lang="en">
  <head>
    ...
    <title>Timetools.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/misc/timeTools.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;fontTools.misc.timeTools.py -- tools for working with OpenType timestamps.
&quot;&quot;&quot;
