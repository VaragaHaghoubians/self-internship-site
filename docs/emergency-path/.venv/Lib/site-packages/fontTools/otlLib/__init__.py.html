...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/otlLib/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"OpenType Layout-related functionality.\"\"\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/otlLib/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;OpenType Layout-related functionality.&quot;&quot;&quot;
</code></pre></article>
