...
<html lang="en">
  <head>
    ...
    <title>Error.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/otlLib/error.py</div>
    </header>
    ...
    <script>
      const readerCode = "class OpenTypeLibError(Exception):\n    def __init__(self, message, location):\n        Exception.__init__(self, message)\n        self.location = location\n\n    def __str__(self):\n        message = Exception.__str__(self)\n        if self.location:\n            return f\"{self.location}: {message}\"\n        else:\n            return message\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/otlLib/error.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>class OpenTypeLibError(Exception):
    def __init__(self, message, location):
        Exception.__init__(self, message)
        self.location = location
