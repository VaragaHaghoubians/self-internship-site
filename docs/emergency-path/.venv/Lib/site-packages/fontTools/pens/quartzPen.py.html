...
<html lang="en">
  <head>
    ...
    <title>Quartzpen.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/pens/quartzPen.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from fontTools.pens.basePen import BasePen
