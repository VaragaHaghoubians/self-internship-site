...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/svgLib/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .path import SVGPath, parse_path\n\n__all__ = [\"SVGPath\", \"parse_path\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/svgLib/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .path import SVGPath, parse_path
