...
<html lang="en">
  <head>
    ...
    <title>C F F  2.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/ttLib/tables/C_F_F__2.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from io import BytesIO
from fontTools.ttLib.tables.C_F_F_ import table_C_F_F_
