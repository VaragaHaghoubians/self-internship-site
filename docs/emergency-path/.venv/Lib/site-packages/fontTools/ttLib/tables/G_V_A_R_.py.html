...
<html lang="en">
  <head>
    ...
    <title>G V A R .Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/ttLib/tables/G_V_A_R_.py</div>
    </header>
    ...
    <script>
      const readerCode = "from ._g_v_a_r import table__g_v_a_r\n\n\nclass table_G_V_A_R_(table__g_v_a_r):\n    gid_size = 3\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/ttLib/tables/G_V_A_R_.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ._g_v_a_r import table__g_v_a_r
