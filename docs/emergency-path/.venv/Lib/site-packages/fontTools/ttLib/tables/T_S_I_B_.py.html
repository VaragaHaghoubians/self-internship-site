...
<html lang="en">
  <head>
    ...
    <title>T S I B .Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/ttLib/tables/T_S_I_B_.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\" TSI{B,C,D,J,P,S,V} are private tables used by Microsoft Visual TrueType (VTT)\ntool to store its table source data.\n\nTSIB contains the source text for the ``BASE`` table.\n\nSee also https://learn.microsoft.com/en-us/typography/tools/vtt/tsi-tables\n\"\"\"\n\nfrom .T_S_I_V_ import table_T_S_I_V_\n\n\nclass table_T_S_I_B_(table_T_S_I_V_):\n    pass\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/ttLib/tables/T_S_I_B_.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot; TSI{B,C,D,J,P,S,V} are private tables used by Microsoft Visual TrueType (VTT)
tool to store its table source data.
