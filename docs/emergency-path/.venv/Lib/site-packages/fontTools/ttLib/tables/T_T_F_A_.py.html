...
<html lang="en">
  <head>
    ...
    <title>T T F A .Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/ttLib/tables/T_T_F_A_.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from . import asciiTable
