...
<html lang="en">
  <head>
    ...
    <title> L T A G.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/ttLib/tables/_l_t_a_g.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from fontTools.misc.textTools import bytesjoin, tobytes, safeEval
from . import DefaultTable
import struct
