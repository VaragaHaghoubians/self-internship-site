...
<html lang="en">
  <head>
    ...
    <title> O P B D.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/ttLib/tables/_o_p_b_d.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .otBase import BaseTTXConverter
