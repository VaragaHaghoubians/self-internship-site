...
<html lang="en">
  <head>
    ...
    <title> S B I X.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/ttLib/tables/_s_b_i_x.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from fontTools.misc import sstruct
from fontTools.misc.textTools import safeEval, num2binary, binary2num
from . import DefaultTable
from .sbixStrike import Strike
