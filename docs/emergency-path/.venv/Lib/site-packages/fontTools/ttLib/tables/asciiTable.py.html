...
<html lang="en">
  <head>
    ...
    <title>Asciitable.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/ttLib/tables/asciiTable.py</div>
    </header>
    ...
    <script>
      const readerCode = "from fontTools.misc.textTools import strjoin, tobytes, tostr\nfrom . import DefaultTable\n\n\nclass asciiTable(DefaultTable.DefaultTable):\n    def toXML(self, writer, ttFont):\n        data = tostr(self.data)\n        # removing null bytes. XXX needed??\n        data = data.split(\"\\0\")\n        data = strjoin(data)\n        writer.begintag(\"source\")\n        writer.newline()\n        writer.write_noindent(data)\n        writer.newline()\n        writer.endtag(\"source\")\n        writer.newline()\n\n    def fromXML(self, name, attrs, content, ttFont):\n        lines = strjoin(content).split(\"\\n\")\n        self.data = tobytes(\"\\n\".join(lines[1:-1]))\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/ttLib/tables/asciiTable.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from fontTools.misc.textTools import strjoin, tobytes, tostr
from . import DefaultTable
