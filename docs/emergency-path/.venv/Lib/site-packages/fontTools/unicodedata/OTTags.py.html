...
<html lang="en">
  <head>
    ...
    <title>Ottags.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/unicodedata/OTTags.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Data updated to OpenType 1.8.2 as of January 2018.
