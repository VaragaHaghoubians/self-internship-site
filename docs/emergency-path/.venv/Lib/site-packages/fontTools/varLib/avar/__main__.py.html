...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/varLib/avar/__main__.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>import logging
