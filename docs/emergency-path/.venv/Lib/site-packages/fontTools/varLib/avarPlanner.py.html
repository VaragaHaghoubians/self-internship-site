...
<html lang="en">
  <head>
    ...
    <title>Avarplanner.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Avarplanner.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/varLib/avarPlanner.py</div>
    </header>
    ...
    <script>
      const readerCode = "def main(args=None):\n    from .avar.plan import main\n\n    main(args)\n\n\nif __name__ == \"__main__\":\n    main()\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/varLib/avarPlanner.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>def main(args=None):
    from .avar.plan import main
