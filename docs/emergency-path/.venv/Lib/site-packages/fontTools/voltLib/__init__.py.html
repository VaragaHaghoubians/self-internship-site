...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/voltLib/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"fontTools.voltLib -- a package for dealing with Visual OpenType Layout Tool\n(VOLT) files.\"\"\"\n\n# See\n# http://www.microsoft.com/typography/VOLT.mspx\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/voltLib/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;fontTools.voltLib -- a package for dealing with Visual OpenType Layout Tool
(VOLT) files.&quot;&quot;&quot;
