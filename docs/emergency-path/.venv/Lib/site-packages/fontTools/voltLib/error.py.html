...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/fontTools/voltLib/error.py</div>
    </header>
    ...
    <script>
      const readerCode = "class VoltLibError(Exception):\n    def __init__(self, message, location):\n        Exception.__init__(self, message)\n        self.location = location\n\n    def __str__(self):\n        message = Exception.__str__(self)\n        if self.location:\n            path, line, column = self.location\n            return \"%s:%d:%d: %s\" % (path, line, column, message)\n        else:\n            return message\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/fontTools/voltLib/error.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>class VoltLibError(Exception):
    def __init__(self, message, location):
        Exception.__init__(self, message)
        self.location = location
