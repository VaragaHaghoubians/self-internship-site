...
<html lang="en">
  <head>
    ...
    <title>Fail Switch Two Greenlets.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Fail Switch Two Greenlets.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/greenlet/tests/fail_switch_two_greenlets.py</div>
    </header>
    ...
    <script>
      ...
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/greenlet/tests/fail_switch_two_greenlets.py";
