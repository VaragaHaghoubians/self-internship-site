...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/httpx/__version__.py</div>
    </header>
    ...
    <script>
      const readerCode = "__title__ = \"httpx\"\n__description__ = \"A next generation HTTP client, for Python 3.\"\n__version__ = \"0.28.1\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/httpx/__version__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__title__ = &quot;httpx&quot;
__description__ = &quot;A next generation HTTP client, for Python 3.&quot;
__version__ = &quot;0.28.1&quot;
</code></pre></article>
