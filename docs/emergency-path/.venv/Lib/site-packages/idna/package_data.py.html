...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/idna/package_data.py</div>
    </header>
    ...
    <script>
      const readerCode = "__version__ = \"3.13\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/idna/package_data.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__version__ = &quot;3.13&quot;
</code></pre></article>
