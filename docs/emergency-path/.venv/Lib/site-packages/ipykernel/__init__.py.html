...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/ipykernel/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from ._version import (\n    __version__,\n    kernel_protocol_version,\n    kernel_protocol_version_info,\n    version_info,\n)\nfrom .connect import *  # noqa: F403\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/ipykernel/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ._version import (
    __version__,
    kernel_protocol_version,
    kernel_protocol_version_info,
    version_info,
