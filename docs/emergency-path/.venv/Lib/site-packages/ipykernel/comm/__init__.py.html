...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/ipykernel/comm/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "__all__ = [\"Comm\", \"CommManager\"]\n\nfrom .comm import Comm\nfrom .manager import CommManager\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/ipykernel/comm/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__all__ = [&quot;Comm&quot;, &quot;CommManager&quot;]
