...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/ipykernel/inprocess/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .blocking import BlockingInProcessKernelClient\nfrom .channels import InProcessChannel, InProcessHBChannel\nfrom .client import InProcessKernelClient\nfrom .manager import InProcessKernelManager\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/ipykernel/inprocess/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .blocking import BlockingInProcessKernelClient
from .channels import InProcessChannel, InProcessHBChannel
from .client import InProcessKernelClient
from .manager import InProcessKernelManager
</code></pre></article>
