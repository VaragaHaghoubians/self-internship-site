...
<html lang="en">
  <head>
    ...
    <title>Socket.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/ipykernel/inprocess/socket.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Defines a dummy socket implementing (part of) the zmq.Socket interface.&quot;&quot;&quot;
