...
<html lang="en">
  <head>
    ...
    <title>Backend Inline.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Backend Inline.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/ipykernel/pylab/backend_inline.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"A matplotlib backend for publishing figures via display_data\"\"\"\n\n# Copyright (c) IPython Development Team.\n# Distributed under the terms of the Modified BSD License.\n\nimport warnings\n\nfrom matplotlib_inline.backend_inline import *  # noqa: F403  # analysis: ignore\n\nwarnings.warn(\n    \"`ipykernel.pylab.backend_inline` is deprecated, directly \"\n    \"use `matplotlib_inline.backend_inline`\",\n    DeprecationWarning,\n    stacklevel=2,\n)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/ipykernel/pylab/backend_inline.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;A matplotlib backend for publishing figures via display_data&quot;&quot;&quot;
