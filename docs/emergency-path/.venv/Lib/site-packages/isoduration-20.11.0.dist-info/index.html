...
<html lang="en">
  <head>
    ...
    <title>isoduration-20.11.0.dist-info - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
