...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/isoduration/__init__.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from isoduration.formatter import format_duration
from isoduration.formatter.exceptions import DurationFormattingException
from isoduration.parser import parse_duration
from isoduration.parser.exceptions import DurationParsingException
