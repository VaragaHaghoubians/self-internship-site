...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/isoduration/constants.py</div>
    </header>
    ...
    <script>
      const readerCode = "PERIOD_PREFIX = \"P\"\nTIME_PREFIX = \"T\"\nWEEK_PREFIX = \"W\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/isoduration/constants.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>PERIOD_PREFIX = &quot;P&quot;
TIME_PREFIX = &quot;T&quot;
WEEK_PREFIX = &quot;W&quot;
</code></pre></article>
