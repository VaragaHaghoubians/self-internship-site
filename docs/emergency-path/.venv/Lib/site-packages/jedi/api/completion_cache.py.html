...
<html lang="en">
  <head>
    ...
    <title>Completion Cache.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Completion Cache.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jedi/api/completion_cache.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from typing import Dict, Tuple, Callable
