...
<html lang="en">
  <head>
    ...
    <title>refactoring - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jedi/api/refactoring</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="__init__.py.html"><strong>__init__.py</strong><span>emergency-path/.venv/Lib/site-packages/jedi/api/refactoring/__init__.py</span></a><a class="dir-item" href="extract.py.html"><strong>extract.py</strong><span>emergency-path/.venv/Lib/site-packages/jedi/api/refactoring/extract.py</span></a></div></article>
