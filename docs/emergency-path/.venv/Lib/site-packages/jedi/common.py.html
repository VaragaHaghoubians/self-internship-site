...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jedi/common.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from contextlib import contextmanager
