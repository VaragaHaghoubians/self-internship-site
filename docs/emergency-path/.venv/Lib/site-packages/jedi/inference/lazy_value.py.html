...
<html lang="en">
  <head>
    ...
    <title>Lazy Value.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jedi/inference/lazy_value.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from jedi.inference.base_value import ValueSet, NO_VALUES
from jedi.common import monkeypatch
