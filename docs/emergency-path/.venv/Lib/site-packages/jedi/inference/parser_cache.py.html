...
<html lang="en">
  <head>
    ...
    <title>Parser Cache.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Parser Cache.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jedi/inference/parser_cache.py</div>
    </header>
    ...
    <script>
      const readerCode = "from jedi.inference.cache import inference_state_function_cache\n\n\n@inference_state_function_cache()\ndef get_yield_exprs(inference_state, funcdef):\n    return list(funcdef.iter_yield_exprs())\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jedi/inference/parser_cache.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from jedi.inference.cache import inference_state_function_cache
