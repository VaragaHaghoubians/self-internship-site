...
<html lang="en">
  <head>
    ...
    <title>Flask.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jedi/plugins/flask.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>def import_module(callback):
    &quot;&quot;&quot;
    Handle &quot;magic&quot; Flask extension imports:
    ``flask.ext.foo`` is really ``flask_foo`` or ``flaskext.foo``.
    &quot;&quot;&quot;
