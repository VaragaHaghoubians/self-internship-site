...
<html lang="en">
  <head>
    ...
    <title>Constants.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jinja2/constants.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>#: list of lorem ipsum words used by the lipsum() helper function
LOREM_IPSUM_WORDS = &quot;&quot;&quot;\
a ac accumsan ad adipiscing aenean aliquam aliquet amet ante aptent arcu at
auctor augue bibendum blandit class commodo condimentum congue consectetuer
consequat conubia convallis cras cubilia cum curabitur curae cursus dapibus
