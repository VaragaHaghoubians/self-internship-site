...
<html lang="en">
  <head>
    ...
    <title>Visitor.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jinja2/visitor.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;API for traversing the AST nodes. Implemented by the compiler and
meta introspection.
&quot;&quot;&quot;
