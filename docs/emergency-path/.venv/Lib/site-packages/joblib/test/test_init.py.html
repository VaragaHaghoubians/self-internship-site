...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/joblib/test/test_init.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Basic test case to test functioning of module&#x27;s top-level
