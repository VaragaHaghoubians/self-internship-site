...
<html lang="en">
  <head>
    ...
    <title>draft201909 - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jsonschema_specifications/schemas/draft201909</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="metaschema.json.html"><strong>metaschema.json</strong><span>emergency-path/.venv/Lib/site-packages/jsonschema_specifications/schemas/draft201909/metaschema.json</span></a></div></article>
