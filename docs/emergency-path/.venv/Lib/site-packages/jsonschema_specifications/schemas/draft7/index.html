...
<html lang="en">
  <head>
    ...
    <title>draft7 - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
