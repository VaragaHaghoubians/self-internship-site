...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_client/asynchronous/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .client import AsyncKernelClient  # noqa\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_client/asynchronous/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .client import AsyncKernelClient  # noqa
</code></pre></article>
