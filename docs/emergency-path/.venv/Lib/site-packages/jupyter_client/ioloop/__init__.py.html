...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_client/ioloop/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .manager import AsyncIOLoopKernelManager  # noqa\nfrom .manager import IOLoopKernelManager  # noqa\nfrom .restarter import AsyncIOLoopKernelRestarter  # noqa\nfrom .restarter import IOLoopKernelRestarter  # noqa\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_client/ioloop/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .manager import AsyncIOLoopKernelManager  # noqa
from .manager import IOLoopKernelManager  # noqa
from .restarter import AsyncIOLoopKernelRestarter  # noqa
from .restarter import IOLoopKernelRestarter  # noqa
</code></pre></article>
