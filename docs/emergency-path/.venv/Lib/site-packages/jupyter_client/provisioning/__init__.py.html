...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_client/provisioning/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .factory import KernelProvisionerFactory  # noqa\nfrom .local_provisioner import LocalProvisioner  # noqa\nfrom .provisioner_base import KernelProvisionerBase  # noqa\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_client/provisioning/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .factory import KernelProvisionerFactory  # noqa
from .local_provisioner import LocalProvisioner  # noqa
from .provisioner_base import KernelProvisionerBase  # noqa
</code></pre></article>
