...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_client/ssh/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .tunnel import *  # noqa\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_client/ssh/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .tunnel import *  # noqa
</code></pre></article>
