...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_core/__main__.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Launch the root jupyter command\"\"\"\n\nfrom __future__ import annotations\n\nfrom .command import main\n\nmain()\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_core/__main__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Launch the root jupyter command&quot;&quot;&quot;
