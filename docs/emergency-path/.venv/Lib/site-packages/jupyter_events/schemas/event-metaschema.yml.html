...
<html lang="en">
  <head>
    ...
    <title>Event Metaschema.Yml - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Event Metaschema.Yml</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_events/schemas/event-metaschema.yml</div>
    </header>
