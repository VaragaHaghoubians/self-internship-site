...
<html lang="en">
  <head>
    ...
    <title>Property Metaschema.Yml - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Property Metaschema.Yml</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_events/schemas/property-metaschema.yml</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>$schema: http://json-schema.org/draft-07/schema
