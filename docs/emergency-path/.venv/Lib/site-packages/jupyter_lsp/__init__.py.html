...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_lsp/__init__.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># flake8: noqa: F401
from ._version import __version__
from .manager import LanguageServerManager, lsp_message_listener
from .serverextension import load_jupyter_server_extension
from .specs.utils import NodeModuleSpec, ShellSpec
