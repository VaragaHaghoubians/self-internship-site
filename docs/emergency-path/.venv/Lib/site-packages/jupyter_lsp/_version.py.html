...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_lsp/_version.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\" single source of truth for jupyter_lsp version\n\"\"\"\n\n__version__ = \"2.3.1\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_lsp/_version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot; single source of truth for jupyter_lsp version
&quot;&quot;&quot;
