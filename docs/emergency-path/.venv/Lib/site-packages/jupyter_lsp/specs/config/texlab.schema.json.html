...
<html lang="en">
  <head>
    ...
    <title>Texlab.Schema.Json - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Texlab.Schema.Json</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_lsp/specs/config/texlab.schema.json</div>
    </header>
