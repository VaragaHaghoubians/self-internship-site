...
<html lang="en">
  <head>
    ...
    <title>Listener.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_lsp/tests/listener.py</div>
    </header>
    ...
    <script>
      const readerCode = "async def dummy_listener(scope, message, language_server, manager):\n    pass\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_lsp/tests/listener.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>async def dummy_listener(scope, message, language_server, manager):
    pass
</code></pre></article>
