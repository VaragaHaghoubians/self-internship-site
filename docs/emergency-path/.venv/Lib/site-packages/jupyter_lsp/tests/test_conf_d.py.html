...
<html lang="en">
  <head>
    ...
    <title>Test Conf D.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Conf D.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_lsp/tests/test_conf_d.py</div>
    </header>
    ...
    <script>
      const readerCode = "def test_conf_d_language_servers(echo_conf_json, handlers, app_config_d):\n    (app_config_d / \"echo.json\").write_text(echo_conf_json)\n    handler, ws_handler = handlers\n    manager = handler.manager\n    manager.initialize()\n    assert \"_echo_\" in [*manager.language_servers]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_lsp/tests/test_conf_d.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>def test_conf_d_language_servers(echo_conf_json, handlers, app_config_d):
    (app_config_d / &quot;echo.json&quot;).write_text(echo_conf_json)
    handler, ws_handler = handlers
    manager = handler.manager
    manager.initialize()
