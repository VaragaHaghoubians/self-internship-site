...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_server/__main__.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"The main entry point for Jupyter Server.\"\"\"\n\nif __name__ == \"__main__\":\n    from jupyter_server import serverapp as app\n\n    app.launch_new_instance()\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_server/__main__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;The main entry point for Jupyter Server.&quot;&quot;&quot;
