...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_server/auth/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .authorizer import *\nfrom .decorator import authorized\nfrom .identity import *\nfrom .security import passwd\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_server/auth/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .authorizer import *
from .decorator import authorized
from .identity import *
from .security import passwd
</code></pre></article>
