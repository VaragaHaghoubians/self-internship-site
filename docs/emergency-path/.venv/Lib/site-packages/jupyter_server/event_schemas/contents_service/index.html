...
<html lang="en">
  <head>
    ...
    <title>contents_service - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>contents_service</h1>
      <p>Clean index for this workspace folder.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_server/event_schemas/contents_service</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="v1.yaml.html"><strong>v1.yaml</strong><span>emergency-path/.venv/Lib/site-packages/jupyter_server/event_schemas/contents_service/v1.yaml</span></a></div></article>
