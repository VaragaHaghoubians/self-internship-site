...
<html lang="en">
  <head>
    ...
    <title>gateway_client - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
