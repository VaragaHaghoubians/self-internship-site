...
<html lang="en">
  <head>
    ...
    <title>V1.Yaml - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_server/event_schemas/gateway_client/v1.yaml</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>&quot;$id&quot;: https://events.jupyter.org/jupyter_server/gateway_client/v1
version: &quot;1&quot;
