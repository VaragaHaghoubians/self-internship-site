...
<html lang="en">
  <head>
    ...
    <title>kernel_actions - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
