...
<html lang="en">
  <head>
    ...
    <title>files - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
