...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_server/services/config/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .manager import ConfigManager\n\n__all__ = [\"ConfigManager\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_server/services/config/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .manager import ConfigManager
