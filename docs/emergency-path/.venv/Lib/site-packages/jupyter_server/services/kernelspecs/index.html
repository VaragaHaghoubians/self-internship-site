...
<html lang="en">
  <head>
    ...
    <title>kernelspecs - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
