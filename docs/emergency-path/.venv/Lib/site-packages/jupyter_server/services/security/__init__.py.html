...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_server/services/security/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "# URI for the CSP Report. Included here to prevent a cyclic dependency.\n# csp_report_uri is needed both by the BaseHandler (for setting the report-uri)\n# and by the CSPReportHandler (which depends on the BaseHandler).\ncsp_report_uri = r\"/api/security/csp-report\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_server/services/security/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># URI for the CSP Report. Included here to prevent a cyclic dependency.
# csp_report_uri is needed both by the BaseHandler (for setting the report-uri)
# and by the CSPReportHandler (which depends on the BaseHandler).
csp_report_uri = r&quot;/api/security/csp-report&quot;
</code></pre></article>
