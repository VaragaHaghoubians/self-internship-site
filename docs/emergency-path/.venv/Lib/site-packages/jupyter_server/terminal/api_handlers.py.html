...
<html lang="en">
  <head>
    ...
    <title>Api Handlers.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Api Handlers.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_server/terminal/api_handlers.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Terminal API handlers.\"\"\"\n\nfrom jupyter_server_terminals.api_handlers import (\n    TerminalAPIHandler,\n    TerminalHandler,\n    TerminalRootHandler,\n)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_server/terminal/api_handlers.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Terminal API handlers.&quot;&quot;&quot;
