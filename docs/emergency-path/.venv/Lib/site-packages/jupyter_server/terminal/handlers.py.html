...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_server/terminal/handlers.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Tornado handlers for the terminal emulator.\"\"\"\n\n# Copyright (c) Jupyter Development Team.\n# Distributed under the terms of the Modified BSD License.\n\nfrom jupyter_server_terminals.handlers import TermSocket\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_server/terminal/handlers.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Tornado handlers for the terminal emulator.&quot;&quot;&quot;
