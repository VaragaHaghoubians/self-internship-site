...
<html lang="en">
  <head>
    ...
    <title>Terminalmanager.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Terminalmanager.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_server/terminal/terminalmanager.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"A MultiTerminalManager for use in the notebook webserver\n- raises HTTPErrors\n- creates REST API models\n\"\"\"\n\n# Copyright (c) Jupyter Development Team.\n# Distributed under the terms of the Modified BSD License.\n\nfrom jupyter_server_terminals.terminalmanager import TerminalManager\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_server/terminal/terminalmanager.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;A MultiTerminalManager for use in the notebook webserver
- raises HTTPErrors
- creates REST API models
&quot;&quot;&quot;
