...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_server_terminals/_version.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Version info for jupyter_server_terminals.\"\"\"\n__version__ = \"0.5.4\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyter_server_terminals/_version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Version info for jupyter_server_terminals.&quot;&quot;&quot;
__version__ = &quot;0.5.4&quot;
</code></pre></article>
