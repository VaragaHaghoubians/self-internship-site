...
<html lang="en">
  <head>
    ...
    <title>Rest Api.Yml - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyter_server_terminals/rest-api.yml</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>openapi: 3.0.1
info:
