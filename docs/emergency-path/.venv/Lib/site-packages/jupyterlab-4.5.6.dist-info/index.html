...
<html lang="en">
  <head>
    ...
    <title>jupyterlab-4.5.6.dist-info - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
