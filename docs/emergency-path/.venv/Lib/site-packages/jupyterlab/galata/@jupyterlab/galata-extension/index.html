...
<html lang="en">
  <head>
    ...
    <title>galata-extension - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>galata-extension</h1>
      <p>Clean index for this workspace folder.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab/galata/@jupyterlab/galata-extension</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="build_log.json.html"><strong>build_log.json</strong><span>emergency-path/.venv/Lib/site-packages/jupyterlab/galata/@jupyterlab/galata-extension/build_log.json</span></a><a class="dir-item" href="package.json.html"><strong>package.json</strong><span>emergency-path/.venv/Lib/site-packages/jupyterlab/galata/@jupyterlab/galata-extension/package.json</span></a></div></article>
