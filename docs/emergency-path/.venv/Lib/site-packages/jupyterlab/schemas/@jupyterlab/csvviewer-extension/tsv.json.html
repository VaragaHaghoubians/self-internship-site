...
<html lang="en">
  <head>
    ...
    <title>Tsv.Json - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab/schemas/@jupyterlab/csvviewer-extension/tsv.json</div>
    </header>
