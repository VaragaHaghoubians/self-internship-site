...
<html lang="en">
  <head>
    ...
    <title>debugger-extension - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab/schemas/@jupyterlab/debugger-extension</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="main.json.html"><strong>main.json</strong><span>emergency-path/.venv/Lib/site-packages/jupyterlab/schemas/@jupyterlab/debugger-extension/main.json</span></a></div></article>
