...
<html lang="en">
  <head>
    ...
    <title>Jupyter Forum.Json - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Jupyter Forum.Json</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab/schemas/@jupyterlab/help-extension/jupyter-forum.json</div>
    </header>
