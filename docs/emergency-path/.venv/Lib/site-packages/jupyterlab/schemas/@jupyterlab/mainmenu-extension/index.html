...
<html lang="en">
  <head>
    ...
    <title>mainmenu-extension - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
