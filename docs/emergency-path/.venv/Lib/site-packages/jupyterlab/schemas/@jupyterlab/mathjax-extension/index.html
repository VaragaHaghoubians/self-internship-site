...
<html lang="en">
  <head>
    ...
    <title>mathjax-extension - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
