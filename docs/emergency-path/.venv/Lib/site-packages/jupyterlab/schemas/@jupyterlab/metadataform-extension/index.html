...
<html lang="en">
  <head>
    ...
    <title>metadataform-extension - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>metadataform-extension</h1>
      <p>Clean index for this workspace folder.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab/schemas/@jupyterlab/metadataform-extension</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="metadataforms.json.html"><strong>metadataforms.json</strong><span>emergency-path/.venv/Lib/site-packages/jupyterlab/schemas/@jupyterlab/metadataform-extension/metadataforms.json</span></a></div></article>
