...
<html lang="en">
  <head>
    ...
    <title>statusbar-extension - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
