...
<html lang="en">
  <head>
    ...
    <title>staging - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab/staging</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href=".yarnrc.yml.html"><strong>.yarnrc.yml</strong><span>emergency-path/.venv/Lib/site-packages/jupyterlab/staging/.yarnrc.yml</span></a><a class="dir-item" href="package.json.html"><strong>package.json</strong><span>emergency-path/.venv/Lib/site-packages/jupyterlab/staging/package.json</span></a></div></article>
