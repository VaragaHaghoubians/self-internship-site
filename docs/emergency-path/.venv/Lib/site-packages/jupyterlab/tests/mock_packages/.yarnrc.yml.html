...
<html lang="en">
  <head>
    ...
    <title>.Yarnrc.Yml - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab/tests/mock_packages/.yarnrc.yml</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>enableImmutableInstalls: false
