...
<html lang="en">
  <head>
    ...
    <title>Mock Service Manager Package.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Mock Service Manager Package.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab/tests/mock_packages/service-manager-extension/mock_service_manager_package.py</div>
    </header>
    ...
    <script>
      const readerCode = "# Copyright (c) Jupyter Development Team.\n# Distributed under the terms of the Modified BSD License.\n\nimport json\nimport os.path as osp\n\nHERE = osp.abspath(osp.dirname(__file__))\n\nwith open(osp.join(HERE, \"package.json\")) as fid:\n    data = json.load(fid)\n\n\ndef _jupyter_labextension_paths():\n    return [{\"src\": data[\"jupyterlab\"].get(\"outputDir\", \"static\"), \"dest\": data[\"name\"]}]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyterlab/tests/mock_packages/service-manager-extension/mock_service_manager_package.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Copyright (c) Jupyter Development Team.
# Distributed under the terms of the Modified BSD License.
