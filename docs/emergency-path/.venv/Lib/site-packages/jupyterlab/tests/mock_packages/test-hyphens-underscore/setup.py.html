...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab/tests/mock_packages/test-hyphens-underscore/setup.py</div>
    </header>
    ...
    <script>
      ...
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyterlab/tests/mock_packages/test-hyphens-underscore/setup.py";
