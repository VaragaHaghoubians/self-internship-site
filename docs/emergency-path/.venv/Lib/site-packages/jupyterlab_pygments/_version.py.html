...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab_pygments/_version.py</div>
    </header>
    ...
    <script>
      const readerCode = "# This file is auto-generated by Hatchling. As such, do not:\n#   - modify\n#   - track in version control e.g. be sure to add to .gitignore\n__version__ = VERSION = '0.3.0'\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/jupyterlab_pygments/_version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># This file is auto-generated by Hatchling. As such, do not:
#   - modify
#   - track in version control e.g. be sure to add to .gitignore
__version__ = VERSION = &#x27;0.3.0&#x27;
</code></pre></article>
