...
<html lang="en">
  <head>
    ...
    <title>app-settings - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab_server/test_data/app-settings</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="overrides.json.html"><strong>overrides.json</strong><span>emergency-path/.venv/Lib/site-packages/jupyterlab_server/test_data/app-settings/overrides.json</span></a></div></article>
