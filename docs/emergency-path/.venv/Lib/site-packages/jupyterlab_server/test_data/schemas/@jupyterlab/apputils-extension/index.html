...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab_server/test_data/schemas/@jupyterlab/apputils-extension</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="themes.json.html"><strong>themes.json</strong><span>emergency-path/.venv/Lib/site-packages/jupyterlab_server/test_data/schemas/@jupyterlab/apputils-extension/themes.json</span></a></div></article>
