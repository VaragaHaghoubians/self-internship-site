...
<html lang="en">
  <head>
    ...
    <title>Commands.Json - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/jupyterlab_server/test_data/schemas/@jupyterlab/codemirror-extension/commands.json</div>
    </header>
