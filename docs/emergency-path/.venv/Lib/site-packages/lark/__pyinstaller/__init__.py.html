...
<html lang="en">
  <head>
    ...
    <title>  Init  .Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/lark/__pyinstaller/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "# For usage of lark with PyInstaller. See https://pyinstaller-sample-hook.readthedocs.io/en/latest/index.html\n\nimport os\n\ndef get_hook_dirs():\n    return [os.path.dirname(__file__)]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/lark/__pyinstaller/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># For usage of lark with PyInstaller. See https://pyinstaller-sample-hook.readthedocs.io/en/latest/index.html
