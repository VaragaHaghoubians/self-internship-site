...
<html lang="en">
  <head>
    ...
    <title> Native.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/markupsafe/_native.py</div>
    </header>
    ...
    <script>
      const readerCode = "def _escape_inner(s: str, /) -> str:\n    return (\n        s.replace(\"&\", \"&amp;\")\n        .replace(\">\", \"&gt;\")\n        .replace(\"<\", \"&lt;\")\n        .replace(\"'\", \"&#39;\")\n        .replace('\"', \"&#34;\")\n    )\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/markupsafe/_native.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>def _escape_inner(s: str, /) -&gt; str:
    return (
        s.replace(&quot;&amp;&quot;, &quot;&amp;amp;&quot;)
        .replace(&quot;&gt;&quot;, &quot;&amp;gt;&quot;)
        .replace(&quot;&lt;&quot;, &quot;&amp;lt;&quot;)
