...
<html lang="en">
  <head>
    ...
    <title>mistune-3.2.0.dist-info - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>mistune-3.2.0.dist-info</h1>
      <p>Clean index for this workspace folder.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/mistune-3.2.0.dist-info</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="top_level.txt.html"><strong>top_level.txt</strong><span>emergency-path/.venv/Lib/site-packages/mistune-3.2.0.dist-info/top_level.txt</span></a></div></article>
