...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/nbclient/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from ._version import __version__, version_info\nfrom .client import NotebookClient, execute\n\n__all__ = [\"__version__\", \"version_info\", \"NotebookClient\", \"execute\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/nbclient/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ._version import __version__, version_info
from .client import NotebookClient, execute
