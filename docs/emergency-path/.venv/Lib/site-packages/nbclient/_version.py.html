...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/nbclient/_version.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Version info.\"\"\"\nfrom __future__ import annotations\n\nimport re\n\n__version__ = \"0.10.4\"\n\n# Build up version_info tuple for backwards compatibility\npattern = r\"(?P<major>\\d+).(?P<minor>\\d+).(?P<patch>\\d+)(?P<rest>.*)\"\nmatch = re.match(pattern, __version__)\nif match:\n    parts: list[int | str] = [int(match[part]) for part in [\"major\", \"minor\", \"patch\"]]\n    if match[\"rest\"]:\n        parts.append(match[\"rest\"])\nelse:\n    parts = []\nversion_info = tuple(parts)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/nbclient/_version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Version info.&quot;&quot;&quot;
from __future__ import annotations
