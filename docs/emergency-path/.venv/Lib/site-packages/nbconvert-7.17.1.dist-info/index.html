...
<html lang="en">
  <head>
    ...
    <title>nbconvert-7.17.1.dist-info - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
