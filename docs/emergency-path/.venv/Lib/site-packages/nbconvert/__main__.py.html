...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/nbconvert/__main__.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"nbconvert cli entry point.\"\"\"\n\nfrom .nbconvertapp import main\n\nmain()\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/nbconvert/__main__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;nbconvert cli entry point.&quot;&quot;&quot;
