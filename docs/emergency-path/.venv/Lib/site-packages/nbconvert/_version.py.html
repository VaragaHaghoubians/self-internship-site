...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/nbconvert/_version.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"nbconvert version info.\"\"\"\n\nimport re\n\n# Version string must appear intact for versioning\n__version__ = \"7.17.1\"\n\n# Build up version_info tuple for backwards compatibility\npattern = r\"(?P<major>\\d+).(?P<minor>\\d+).(?P<patch>\\d+)(?P<rest>.*)\"\nmatch = re.match(pattern, __version__)\nassert match is not None\nparts: list[object] = [int(match[part]) for part in [\"major\", \"minor\", \"patch\"]]\nif match[\"rest\"]:\n    parts.append(match[\"rest\"])\nversion_info = tuple(parts)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/nbconvert/_version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;nbconvert version info.&quot;&quot;&quot;
