...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/nbconvert/conftest.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"pytest configuration.\"\"\"\n\nimport asyncio\nimport os\n\nif os.name == \"nt\":\n    asyncio.set_event_loop_policy(\n        asyncio.WindowsSelectorEventLoopPolicy()  # type:ignore[attr-defined]\n    )\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/nbconvert/conftest.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;pytest configuration.&quot;&quot;&quot;
