...
<html lang="en">
  <head>
    ...
    <title>Widgetsdatatypefilter.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Widgetsdatatypefilter.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/nbconvert/filters/widgetsdatatypefilter.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Filter used to select the first preferred output format available,
excluding interactive widget format if the widget state is not available.
