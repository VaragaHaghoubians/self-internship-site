...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/nbconvert/postprocessors/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .base import PostProcessorBase\n\n# protect against unavailable tornado\ntry:\n    from .serve import ServePostProcessor\nexcept ImportError:\n    ServePostProcessor = None  # type:ignore[misc,assignment]\n\n__all__ = [\"PostProcessorBase\", \"ServePostProcessor\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/nbconvert/postprocessors/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .base import PostProcessorBase
