...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/nbconvert/templates/README.md</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2 id="readme-first">README FIRST</h2>
<p>Please do not add new templates for nbconvert here.</p>
<p>In order to speed up the distribution of nbconvert templates and make it simpler to share such contributions, we encourage <a href="https://github.com/ipython/ipython/wiki/Cookbook:%20nbconvert%20templates">sharing those links on our wiki page</a>.</p></article>
      <aside class="toc"><h2>On this page</h2><a style="margin-left:0px" href="#readme-first">README FIRST</a></aside>
    </main>
  </body>
</html>
