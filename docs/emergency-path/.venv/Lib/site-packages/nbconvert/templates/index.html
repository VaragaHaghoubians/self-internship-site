...
<html lang="en">
  <head>
    ...
    <title>templates - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/nbconvert/templates</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="skeleton/index.html"><strong>skeleton/</strong><span>emergency-path/.venv/Lib/site-packages/nbconvert/templates/skeleton</span></a><a class="dir-item" href="README.md.html"><strong>README.md</strong><span>emergency-path/.venv/Lib/site-packages/nbconvert/templates/README.md</span></a></div></article>
