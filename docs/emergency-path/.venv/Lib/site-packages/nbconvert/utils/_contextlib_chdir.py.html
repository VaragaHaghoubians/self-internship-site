...
<html lang="en">
  <head>
    ...
    <title> Contextlib Chdir.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1> Contextlib Chdir.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/nbconvert/utils/_contextlib_chdir.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Backport of Python 3.11's contextlib.chdir.\"\"\"\n\nimport os\nfrom contextlib import AbstractContextManager\n\n\nclass chdir(AbstractContextManager):  # type:ignore[type-arg]\n    \"\"\"Non thread-safe context manager to change the current working directory.\"\"\"\n\n    def __init__(self, path):\n        \"\"\"Initialize the manager.\"\"\"\n        self.path = path\n        self._old_cwd = []\n\n    def __enter__(self):\n        \"\"\"Enter the context.\"\"\"\n        self._old_cwd.append(os.getcwd())\n        os.chdir(self.path)\n\n    def __exit__(self, *excinfo):\n        \"\"\"Exit the context.\"\"\"\n        os.chdir(self._old_cwd.pop())\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/nbconvert/utils/_contextlib_chdir.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Backport of Python 3.11&#x27;s contextlib.chdir.&quot;&quot;&quot;
