...
<html lang="en">
  <head>
    ...
    <title>Lexers.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/nbconvert/utils/lexers.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Deprecated as of 5.0; import from IPython.lib.lexers instead.\"\"\"\n\nfrom warnings import warn\n\nwarn(\"nbconvert.utils.lexers is deprecated as of 5.0. Use IPython.lib.lexers\", stacklevel=2)\n\nfrom IPython.lib.lexers import *  # noqa: F403, E402\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/nbconvert/utils/lexers.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Deprecated as of 5.0; import from IPython.lib.lexers instead.&quot;&quot;&quot;
