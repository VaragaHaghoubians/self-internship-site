...
<html lang="en">
  <head>
    ...
    <title>Words.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/nbformat/corpus/words.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Generate a corpus id.\"\"\"\n\nfrom __future__ import annotations\n\nimport uuid\n\n\ndef generate_corpus_id():\n    \"\"\"Generate a corpus id.\"\"\"\n    return uuid.uuid4().hex[:8]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/nbformat/corpus/words.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Generate a corpus id.&quot;&quot;&quot;
