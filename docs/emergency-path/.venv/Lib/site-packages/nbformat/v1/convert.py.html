...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/nbformat/v1/convert.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Convert notebook to the v1 format.\"\"\"\n\n# -----------------------------------------------------------------------------\n#  Copyright (C) 2008-2011  The IPython Development Team\n#\n#  Distributed under the terms of the BSD License.  The full license is in\n#  the file LICENSE, distributed as part of this software.\n# -----------------------------------------------------------------------------\n\n# -----------------------------------------------------------------------------\n# Code\n# -----------------------------------------------------------------------------\nfrom __future__ import annotations\n\n\ndef upgrade(nb, orig_version=None):\n    \"\"\"Upgrade a notebook.\"\"\"\n    msg = \"Cannot convert to v1 notebook format\"\n    raise ValueError(msg)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/nbformat/v1/convert.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Convert notebook to the v1 format.&quot;&quot;&quot;
