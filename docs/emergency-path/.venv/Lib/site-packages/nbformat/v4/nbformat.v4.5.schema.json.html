...
<html lang="en">
  <head>
    ...
    <title>Nbformat.V4.5.Schema.Json - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Nbformat.V4.5.Schema.Json</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/nbformat/v4/nbformat.v4.5.schema.json</div>
    </header>
