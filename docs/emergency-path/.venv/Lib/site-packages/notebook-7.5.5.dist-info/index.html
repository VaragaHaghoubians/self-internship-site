...
<html lang="en">
  <head>
    ...
    <title>notebook-7.5.5.dist-info - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
