...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/notebook/__main__.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"CLI entry point for notebook.\"\"\"\n\nimport sys\n\nfrom notebook.app import main\n\nsys.exit(main())  # type:ignore[no-untyped-call]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/notebook/__main__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;CLI entry point for notebook.&quot;&quot;&quot;
