...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/notebook_shim/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "def _jupyter_server_extension_points():\n    return [\n        {\n            'module': 'notebook_shim.nbserver',\n        }\n    ]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/notebook_shim/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>def _jupyter_server_extension_points():
    return [
        {
            &#x27;module&#x27;: &#x27;notebook_shim.nbserver&#x27;,
        }
