...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/notebook_shim/_version.py</div>
    </header>
    ...
    <script>
      const readerCode = "version_info = (0, 2, 4, \"\", \"\")\n__version__ = \"0.2.4\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/notebook_shim/_version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>version_info = (0, 2, 4, &quot;&quot;, &quot;&quot;)
__version__ = &quot;0.2.4&quot;
</code></pre></article>
