...
<html lang="en">
  <head>
    ...
    <title>Jupyter My Ext Config.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Jupyter My Ext Config.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/notebook_shim/tests/confs/jupyter_my_ext_config.py</div>
    </header>
    ...
    <script>
      const readerCode = "c.MyExt.hello = 'My extension'\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/notebook_shim/tests/confs/jupyter_my_ext_config.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>c.MyExt.hello = &#x27;My extension&#x27;
</code></pre></article>
