...
<html lang="en">
  <head>
    ...
    <title>Jupyter Notebook Config.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Jupyter Notebook Config.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/notebook_shim/tests/confs/jupyter_notebook_config.py</div>
    </header>
    ...
    <script>
      const readerCode = "c.NotebookApp.allow_credentials = False\nc.NotebookApp.port = 8889\nc.NotebookApp.password_required = True\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/notebook_shim/tests/confs/jupyter_notebook_config.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>c.NotebookApp.allow_credentials = False
c.NotebookApp.port = 8889
c.NotebookApp.password_required = True
</code></pre></article>
