...
<html lang="en">
  <head>
    ...
    <title>Jupyter Server Config.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Jupyter Server Config.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/notebook_shim/tests/confs/jupyter_server_config.py</div>
    </header>
    ...
    <script>
      const readerCode = "c.ServerApp.port = 7774\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/notebook_shim/tests/confs/jupyter_server_config.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>c.ServerApp.port = 7774
</code></pre></article>
