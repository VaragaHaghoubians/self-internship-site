...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy-2.4.4.dist-info/licenses/numpy/random/src/splitmix64/LICENSE.md</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2 id="splitmix64">SPLITMIX64</h2>
...
<p>See &lt;http://creativecommons.org/publicdomain/zero/1.0/&gt;.</p></article>
      <aside class="toc"><h2>On this page</h2><a style="margin-left:0px" href="#splitmix64">SPLITMIX64</a></aside>
    </main>
  </body>
</html>
