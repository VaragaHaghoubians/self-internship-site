...
<html lang="en">
  <head>
    ...
    <title>Cversions.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/_core/cversions.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Simple script to compute the api hash of the current API.\n\nThe API has is defined by numpy_api_order and ufunc_api_order.\n\n\"\"\"\nfrom os.path import dirname\n\nfrom code_generators.genapi import fullapi_hash\nfrom code_generators.numpy_api import full_api\n\nif __name__ == '__main__':\n    curdir = dirname(__file__)\n    print(fullapi_hash(full_api))\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/_core/cversions.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Simple script to compute the api hash of the current API.
