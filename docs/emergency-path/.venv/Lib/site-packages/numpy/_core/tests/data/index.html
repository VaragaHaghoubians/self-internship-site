...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/_core/tests/data</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="umath-validation-set-README.txt.html"><strong>umath-validation-set-README.txt</strong><span>emergency-path/.venv/Lib/site-packages/numpy/_core/tests/data/umath-validation-set-README.txt</span></a></div></article>
