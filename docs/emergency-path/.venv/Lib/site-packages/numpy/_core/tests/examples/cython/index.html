...
<html lang="en">
  <head>
    ...
    <title>cython - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/_core/tests/examples/cython</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="setup.py.html"><strong>setup.py</strong><span>emergency-path/.venv/Lib/site-packages/numpy/_core/tests/examples/cython/setup.py</span></a></div></article>
