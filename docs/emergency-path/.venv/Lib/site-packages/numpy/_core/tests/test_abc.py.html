...
<html lang="en">
  <head>
    ...
    <title>Test Abc.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/_core/tests/test_abc.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>import numbers
