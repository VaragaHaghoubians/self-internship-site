...
<html lang="en">
  <head>
    ...
    <title>Pyinstaller Smoke.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Pyinstaller Smoke.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/_pyinstaller/tests/pyinstaller-smoke.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;A crude *bit of everything* smoke test to verify PyInstaller compatibility.
