...
<html lang="en">
  <head>
    ...
    <title> Extended Precision.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1> Extended Precision.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/_typing/_extended_precision.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"A module with platform-specific extended precision\n`numpy.number` subclasses.\n\nThe subclasses are defined here (instead of ``__init__.pyi``) such\nthat they can be imported conditionally via the numpy's mypy plugin.\n\"\"\"\n\nimport numpy as np\n\nfrom . import _96Bit, _128Bit\n\nfloat96 = np.floating[_96Bit]\nfloat128 = np.floating[_128Bit]\ncomplex192 = np.complexfloating[_96Bit, _96Bit]\ncomplex256 = np.complexfloating[_128Bit, _128Bit]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/_typing/_extended_precision.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;A module with platform-specific extended precision
`numpy.number` subclasses.
