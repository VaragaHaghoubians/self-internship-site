...
<html lang="en">
  <head>
    ...
    <title> Nbit.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/_typing/_nbit.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;A module with the precisions of platform-specific `~numpy.number`s.&quot;&quot;&quot;
