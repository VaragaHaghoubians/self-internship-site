...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/char/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from numpy._core.defchararray import *\nfrom numpy._core.defchararray import __all__, __doc__\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/char/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from numpy._core.defchararray import *
from numpy._core.defchararray import __all__, __doc__
</code></pre></article>
