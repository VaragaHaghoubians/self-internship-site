...
<html lang="en">
  <head>
    ...
    <title>Function Base.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Function Base.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/core/function_base.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>def __getattr__(attr_name):
    from numpy._core import function_base
