...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/ctypeslib/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from ._ctypeslib import (\n    __all__,\n    __doc__,\n    _concrete_ndptr,\n    _ndptr,\n    as_array,\n    as_ctypes,\n    as_ctypes_type,\n    c_intp,\n    ctypes,\n    load_library,\n    ndpointer,\n)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/ctypeslib/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ._ctypeslib import (
    __all__,
    __doc__,
    _concrete_ndptr,
    _ndptr,
