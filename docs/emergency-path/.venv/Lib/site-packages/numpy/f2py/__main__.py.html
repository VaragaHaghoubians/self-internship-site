...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/f2py/__main__.py</div>
    </header>
    ...
    <script>
      const readerCode = "# See:\n# https://web.archive.org/web/20140822061353/http://cens.ioc.ee/projects/f2py2e\nfrom numpy.f2py.f2py2e import main\n\nmain()\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/f2py/__main__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># See:
# https://web.archive.org/web/20140822061353/http://cens.ioc.ee/projects/f2py2e
from numpy.f2py.f2py2e import main
