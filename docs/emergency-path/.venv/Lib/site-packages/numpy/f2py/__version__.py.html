...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/f2py/__version__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from numpy.version import version  # noqa: F401\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/f2py/__version__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from numpy.version import version  # noqa: F401
</code></pre></article>
