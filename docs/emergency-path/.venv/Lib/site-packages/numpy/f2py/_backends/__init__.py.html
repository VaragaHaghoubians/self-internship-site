...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/f2py/_backends/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "def f2py_build_generator(name):\n    if name == \"meson\":\n        from ._meson import MesonBackend\n        return MesonBackend\n    elif name == \"distutils\":\n        from ._distutils import DistutilsBackend\n        return DistutilsBackend\n    else:\n        raise ValueError(f\"Unknown backend: {name}\")\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/f2py/_backends/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>def f2py_build_generator(name):
    if name == &quot;meson&quot;:
        from ._meson import MesonBackend
        return MesonBackend
    elif name == &quot;distutils&quot;:
