...
<html lang="en">
  <head>
    ...
    <title>Test Pyf Src.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Pyf Src.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/f2py/tests/test_pyf_src.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># This test is ported from numpy.distutils
from numpy.f2py._src_pyf import process_str
from numpy.testing import assert_equal
