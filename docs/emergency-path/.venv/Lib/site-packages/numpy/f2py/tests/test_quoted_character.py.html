...
<html lang="en">
  <head>
    ...
    <title>Test Quoted Character.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Quoted Character.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/f2py/tests/test_quoted_character.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"See https://github.com/numpy/numpy/pull/10676.\n\n\"\"\"\nimport sys\n\nimport pytest\n\nfrom . import util\n\n\nclass TestQuotedCharacter(util.F2PyTest):\n    sources = [util.getpath(\"tests\", \"src\", \"quoted_character\", \"foo.f\")]\n\n    @pytest.mark.skipif(sys.platform == \"win32\",\n                        reason=\"Fails with MinGW64 Gfortran (Issue #9673)\")\n    @pytest.mark.slow\n    def test_quoted_character(self):\n        assert self.module.foo() == (b\"'\", b'\"', b\";\", b\"!\", b\"(\", b\")\")\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/f2py/tests/test_quoted_character.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;See https://github.com/numpy/numpy/pull/10676.
