...
<html lang="en">
  <head>
    ...
    <title>Array Utils.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Array Utils.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/lib/array_utils.py</div>
    </header>
    ...
    <script>
      const readerCode = "from ._array_utils_impl import (  # noqa: F401\n    __all__,\n    __doc__,\n    byte_bounds,\n    normalize_axis_index,\n    normalize_axis_tuple,\n)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/lib/array_utils.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ._array_utils_impl import (  # noqa: F401
    __all__,
    __doc__,
    byte_bounds,
    normalize_axis_index,
