...
<html lang="en">
  <head>
    ...
    <title>Npyio.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/lib/npyio.py</div>
    </header>
    ...
    <script>
      const readerCode = "from ._npyio_impl import DataSource, NpzFile, __doc__  # noqa: F401\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/lib/npyio.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ._npyio_impl import DataSource, NpzFile, __doc__  # noqa: F401
</code></pre></article>
