...
<html lang="en">
  <head>
    ...
    <title>Scimath.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/lib/scimath.py</div>
    </header>
    ...
    <script>
      const readerCode = "from ._scimath_impl import (  # noqa: F401\n    __all__,\n    __doc__,\n    arccos,\n    arcsin,\n    arctanh,\n    log,\n    log2,\n    log10,\n    logn,\n    power,\n    sqrt,\n)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/lib/scimath.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ._scimath_impl import (  # noqa: F401
    __all__,
    __doc__,
    arccos,
    arcsin,
