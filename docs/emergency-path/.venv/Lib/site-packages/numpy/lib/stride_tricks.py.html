...
<html lang="en">
  <head>
    ...
    <title>Stride Tricks.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Stride Tricks.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/lib/stride_tricks.py</div>
    </header>
    ...
    <script>
      const readerCode = "from ._stride_tricks_impl import __doc__, as_strided, sliding_window_view  # noqa: F401\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/lib/stride_tricks.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ._stride_tricks_impl import __doc__, as_strided, sliding_window_view  # noqa: F401
</code></pre></article>
