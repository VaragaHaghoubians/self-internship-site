...
<html lang="en">
  <head>
    ...
    <title>User Array.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/lib/user_array.py</div>
    </header>
    ...
    <script>
      const readerCode = "from ._user_array_impl import __doc__, container  # noqa: F401\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/lib/user_array.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ._user_array_impl import __doc__, container  # noqa: F401
</code></pre></article>
