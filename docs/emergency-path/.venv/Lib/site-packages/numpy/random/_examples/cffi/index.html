...
<html lang="en">
  <head>
    ...
    <title>cffi - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/random/_examples/cffi</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="extending.py.html"><strong>extending.py</strong><span>emergency-path/.venv/Lib/site-packages/numpy/random/_examples/cffi/extending.py</span></a><a class="dir-item" href="parse.py.html"><strong>parse.py</strong><span>emergency-path/.venv/Lib/site-packages/numpy/random/_examples/cffi/parse.py</span></a></div></article>
