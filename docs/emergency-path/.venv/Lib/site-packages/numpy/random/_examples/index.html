...
<html lang="en">
  <head>
    ...
    <title>_examples - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/random/_examples</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="cffi/index.html"><strong>cffi/</strong><span>emergency-path/.venv/Lib/site-packages/numpy/random/_examples/cffi</span></a><a class="dir-item" href="numba/index.html"><strong>numba/</strong><span>emergency-path/.venv/Lib/site-packages/numpy/random/_examples/numba</span></a></div></article>
