...
<html lang="en">
  <head>
    ...
    <title>Extending Distributions.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Extending Distributions.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/random/_examples/numba/extending_distributions.py</div>
    </header>
    ...
    <script>
      ...
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/random/_examples/numba/extending_distributions.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>r&quot;&quot;&quot;
Building the required library in this example requires a source distribution
of NumPy or clone of the NumPy git repository since distributions.c is not
included in binary distributions.
