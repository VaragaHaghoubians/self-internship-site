...
<html lang="en">
  <head>
    ...
    <title>numba - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/random/_examples/numba</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="extending.py.html"><strong>extending.py</strong><span>emergency-path/.venv/Lib/site-packages/numpy/random/_examples/numba/extending.py</span></a><a class="dir-item" href="extending_distributions.py.html"><strong>extending_distributions.py</strong><span>emergency-path/.venv/Lib/site-packages/numpy/random/_examples/numba/extending_distributions.py</span></a></div></article>
