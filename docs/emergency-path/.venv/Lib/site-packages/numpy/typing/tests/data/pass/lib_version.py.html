...
<html lang="en">
  <head>
    ...
    <title>Lib Version.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Lib Version.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/typing/tests/data/pass/lib_version.py</div>
    </header>
    ...
    <script>
      const readerCode = "from numpy.lib import NumpyVersion\n\nversion = NumpyVersion(\"1.8.0\")\n\nversion.vstring\nversion.version\nversion.major\nversion.minor\nversion.bugfix\nversion.pre_release\nversion.is_devversion\n\nversion == version\nversion != version\nversion < \"1.8.0\"\nversion <= version\nversion > version\nversion >= \"1.8.0\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/typing/tests/data/pass/lib_version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from numpy.lib import NumpyVersion
