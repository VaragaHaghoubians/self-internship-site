...
<html lang="en">
  <head>
    ...
    <title>Shape.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/typing/tests/data/pass/shape.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from typing import Any, NamedTuple
