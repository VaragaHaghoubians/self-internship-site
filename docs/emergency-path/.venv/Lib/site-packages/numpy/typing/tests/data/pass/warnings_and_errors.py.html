...
<html lang="en">
  <head>
    ...
    <title>Warnings And Errors.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Warnings And Errors.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/numpy/typing/tests/data/pass/warnings_and_errors.py</div>
    </header>
    ...
    <script>
      const readerCode = "import numpy.exceptions as ex\n\nex.AxisError(\"test\")\nex.AxisError(1, ndim=2)\nex.AxisError(1, ndim=2, msg_prefix=\"error\")\nex.AxisError(1, ndim=2, msg_prefix=None)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/numpy/typing/tests/data/pass/warnings_and_errors.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>import numpy.exceptions as ex
