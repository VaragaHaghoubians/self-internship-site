...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas-3.0.2.dist-info/entry_points.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>[pandas_plotting_backends]
