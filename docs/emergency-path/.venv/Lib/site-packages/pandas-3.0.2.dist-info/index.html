...
<html lang="en">
  <head>
    ...
    <title>pandas-3.0.2.dist-info - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
