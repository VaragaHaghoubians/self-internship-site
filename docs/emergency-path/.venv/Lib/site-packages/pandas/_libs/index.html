...
<html lang="en">
  <head>
    ...
    <title>_libs - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/_libs</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="tslibs/index.html"><strong>tslibs/</strong><span>emergency-path/.venv/Lib/site-packages/pandas/_libs/tslibs</span></a><a class="dir-item" href="window/index.html"><strong>window/</strong><span>emergency-path/.venv/Lib/site-packages/pandas/_libs/window</span></a><a class="dir-item" href="__init__.py.html"><strong>__init__.py</strong><span>emergency-path/.venv/Lib/site-packages/pandas/_libs/__init__.py</span></a></div></article>
