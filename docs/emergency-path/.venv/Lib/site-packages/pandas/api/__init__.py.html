...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/api/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"public toolkit API\"\"\"\n\nfrom pandas.api import (\n    executors,\n    extensions,\n    indexers,\n    interchange,\n    types,\n    typing,\n)\n\n__all__ = [\n    \"executors\",\n    \"extensions\",\n    \"indexers\",\n    \"interchange\",\n    \"types\",\n    \"typing\",\n]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/api/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;public toolkit API&quot;&quot;&quot;
