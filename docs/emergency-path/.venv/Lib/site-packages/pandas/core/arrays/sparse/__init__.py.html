...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/core/arrays/sparse/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from pandas.core.arrays.sparse.accessor import (\n    SparseAccessor,\n    SparseFrameAccessor,\n)\nfrom pandas.core.arrays.sparse.array import (\n    BlockIndex,\n    IntIndex,\n    SparseArray,\n    make_sparse_index,\n)\n\n__all__ = [\n    \"BlockIndex\",\n    \"IntIndex\",\n    \"SparseAccessor\",\n    \"SparseArray\",\n    \"SparseFrameAccessor\",\n    \"make_sparse_index\",\n]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/core/arrays/sparse/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas.core.arrays.sparse.accessor import (
    SparseAccessor,
    SparseFrameAccessor,
)
from pandas.core.arrays.sparse.array import (
