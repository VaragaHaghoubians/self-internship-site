...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/core/computation/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/core/computation/__init__.py";
