...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/core/computation/api.py</div>
    </header>
    ...
    <script>
      const readerCode = "__all__ = [\"eval\"]\nfrom pandas.core.computation.eval import eval\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/core/computation/api.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__all__ = [&quot;eval&quot;]
from pandas.core.computation.eval import eval
</code></pre></article>
