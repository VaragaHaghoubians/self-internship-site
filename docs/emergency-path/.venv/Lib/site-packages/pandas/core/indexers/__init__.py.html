...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/core/indexers/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from pandas.core.indexers.utils import (\n    check_array_indexer,\n    check_key_length,\n    check_setitem_lengths,\n    disallow_ndim_indexing,\n    getitem_returns_view,\n    is_empty_indexer,\n    is_list_like_indexer,\n    is_scalar_indexer,\n    is_valid_positional_slice,\n    length_of_indexer,\n    maybe_convert_indices,\n    unpack_1tuple,\n    unpack_tuple_and_ellipses,\n    validate_indices,\n)\n\n__all__ = [\n    \"check_array_indexer\",\n    \"check_key_length\",\n    \"check_setitem_lengths\",\n    \"disallow_ndim_indexing\",\n    \"getitem_returns_view\",\n    \"is_empty_indexer\",\n    \"is_list_like_indexer\",\n    \"is_scalar_indexer\",\n    \"is_valid_positional_slice\",\n    \"length_of_indexer\",\n    \"maybe_convert_indices\",\n    \"unpack_1tuple\",\n    \"unpack_tuple_and_ellipses\",\n    \"validate_indices\",\n]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/core/indexers/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas.core.indexers.utils import (
    check_array_indexer,
    check_key_length,
    check_setitem_lengths,
    disallow_ndim_indexing,
