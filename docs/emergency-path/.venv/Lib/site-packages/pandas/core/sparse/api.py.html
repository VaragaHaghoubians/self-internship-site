...
<html lang="en">
  <head>
    ...
    <title>Api.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/core/sparse/api.py</div>
    </header>
    ...
    <script>
      const readerCode = "from pandas.core.dtypes.dtypes import SparseDtype\n\nfrom pandas.core.arrays.sparse import SparseArray\n\n__all__ = [\"SparseArray\", \"SparseDtype\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/core/sparse/api.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas.core.dtypes.dtypes import SparseDtype
