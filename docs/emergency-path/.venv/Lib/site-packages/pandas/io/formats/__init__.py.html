...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/io/formats/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "# ruff: noqa: TC004\nfrom typing import TYPE_CHECKING\n\nif TYPE_CHECKING:\n    # import modules that have public classes/functions\n    from pandas.io.formats import style\n\n    # and mark only those modules as public\n    __all__ = [\"style\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/io/formats/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># ruff: noqa: TC004
from typing import TYPE_CHECKING
