...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/io/parsers/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from pandas.io.parsers.readers import (\n    TextFileReader,\n    TextParser,\n    read_csv,\n    read_fwf,\n    read_table,\n)\n\n__all__ = [\"TextFileReader\", \"TextParser\", \"read_csv\", \"read_fwf\", \"read_table\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/io/parsers/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas.io.parsers.readers import (
    TextFileReader,
    TextParser,
    read_csv,
    read_fwf,
