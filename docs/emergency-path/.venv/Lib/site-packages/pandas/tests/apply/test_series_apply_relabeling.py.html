...
<html lang="en">
  <head>
    ...
    <title>Test Series Apply Relabeling.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Series Apply Relabeling.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/apply/test_series_apply_relabeling.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>import pandas as pd
import pandas._testing as tm
