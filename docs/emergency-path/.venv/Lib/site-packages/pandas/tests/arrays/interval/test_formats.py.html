...
<html lang="en">
  <head>
    ...
    <title>Test Formats.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Formats.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/arrays/interval/test_formats.py</div>
    </header>
    ...
    <script>
      const readerCode = "from pandas.core.arrays import IntervalArray\n\n\ndef test_repr():\n    # GH#25022\n    arr = IntervalArray.from_tuples([(0, 1), (1, 2)])\n    result = repr(arr)\n    expected = (\n        \"<IntervalArray>\\n[(0, 1], (1, 2]]\\nLength: 2, dtype: interval[int64, right]\"\n    )\n    assert result == expected\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/tests/arrays/interval/test_formats.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas.core.arrays import IntervalArray
