...
<html lang="en">
  <head>
    ...
    <title>Test Extract Array.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Extract Array.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/construction/test_extract_array.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas import Index
import pandas._testing as tm
from pandas.core.construction import extract_array
