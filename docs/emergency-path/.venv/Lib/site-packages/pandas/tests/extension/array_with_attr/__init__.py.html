...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/extension/array_with_attr/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from pandas.tests.extension.array_with_attr.array import (\n    FloatAttrArray,\n    FloatAttrDtype,\n)\n\n__all__ = [\"FloatAttrArray\", \"FloatAttrDtype\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/tests/extension/array_with_attr/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas.tests.extension.array_with_attr.array import (
    FloatAttrArray,
    FloatAttrDtype,
)
