...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/extension/base/base.py</div>
    </header>
    ...
    <script>
      const readerCode = "class BaseExtensionTests:\n    pass\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/tests/extension/base/base.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>class BaseExtensionTests:
    pass
</code></pre></article>
