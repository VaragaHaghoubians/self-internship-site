...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/extension/date/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from pandas.tests.extension.date.array import (\n    DateArray,\n    DateDtype,\n)\n\n__all__ = [\"DateArray\", \"DateDtype\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/tests/extension/date/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas.tests.extension.date.array import (
    DateArray,
    DateDtype,
)
