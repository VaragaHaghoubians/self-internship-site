...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/extension/decimal/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from pandas.tests.extension.decimal.array import (\n    DecimalArray,\n    DecimalDtype,\n    make_data,\n    to_decimal,\n)\n\n__all__ = [\"DecimalArray\", \"DecimalDtype\", \"make_data\", \"to_decimal\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/tests/extension/decimal/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas.tests.extension.decimal.array import (
    DecimalArray,
    DecimalDtype,
    make_data,
    to_decimal,
