...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/extension/json/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from pandas.tests.extension.json.array import (\n    JSONArray,\n    JSONDtype,\n    make_data,\n)\n\n__all__ = [\"JSONArray\", \"JSONDtype\", \"make_data\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/tests/extension/json/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas.tests.extension.json.array import (
    JSONArray,
    JSONDtype,
    make_data,
)
