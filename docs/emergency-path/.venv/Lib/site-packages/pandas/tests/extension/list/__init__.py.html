...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/extension/list/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from pandas.tests.extension.list.array import (\n    ListArray,\n    ListDtype,\n    make_data,\n)\n\n__all__ = [\"ListArray\", \"ListDtype\", \"make_data\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/tests/extension/list/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas.tests.extension.list.array import (
    ListArray,
    ListDtype,
    make_data,
)
