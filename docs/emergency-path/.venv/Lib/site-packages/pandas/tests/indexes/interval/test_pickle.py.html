...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/indexes/interval/test_pickle.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas import IntervalIndex
import pandas._testing as tm
