...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/indexes/multi/test_copy.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from copy import (
    copy,
    deepcopy,
)
