...
<html lang="en">
  <head>
    ...
    <title>Test Arithmetic.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Arithmetic.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/indexes/timedeltas/test_arithmetic.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Arithmetic tests for TimedeltaIndex are generally about the result&#x27;s `freq` attribute.
# Other cases can be shared in tests.arithmetic.test_timedelta64
import numpy as np
