...
<html lang="en">
  <head>
    ...
    <title>Test Pickle.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Pickle.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/indexes/timedeltas/test_pickle.py</div>
    </header>
    ...
    <script>
      const readerCode = "from pandas import timedelta_range\nimport pandas._testing as tm\n\n\nclass TestPickle:\n    def test_pickle_after_set_freq(self, temp_file):\n        tdi = timedelta_range(\"1 day\", periods=4, freq=\"s\")\n        tdi = tdi._with_freq(None)\n\n        res = tm.round_trip_pickle(tdi, temp_file)\n        tm.assert_index_equal(res, tdi)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/tests/indexes/timedeltas/test_pickle.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas import timedelta_range
import pandas._testing as tm
