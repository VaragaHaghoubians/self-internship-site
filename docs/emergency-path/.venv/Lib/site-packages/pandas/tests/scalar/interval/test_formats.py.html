...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pandas/tests/scalar/interval/test_formats.py</div>
    </header>
    ...
    <script>
      const readerCode = "from pandas import Interval\n\n\ndef test_interval_repr():\n    interval = Interval(0, 1)\n    assert repr(interval) == \"Interval(0, 1, closed='right')\"\n    assert str(interval) == \"(0, 1]\"\n\n    interval_left = Interval(0, 1, closed=\"left\")\n    assert repr(interval_left) == \"Interval(0, 1, closed='left')\"\n    assert str(interval_left) == \"[0, 1)\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pandas/tests/scalar/interval/test_formats.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pandas import Interval
