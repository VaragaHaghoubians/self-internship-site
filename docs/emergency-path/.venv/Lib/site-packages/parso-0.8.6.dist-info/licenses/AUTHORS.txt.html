...
<html lang="en">
  <head>
    ...
    <title>Authors.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/parso-0.8.6.dist-info/licenses/AUTHORS.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>Main Authors
============
