...
<html lang="en">
  <head>
    ...
    <title>Status Codes.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Status Codes.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_internal/cli/status_codes.py</div>
    </header>
    ...
    <script>
      const readerCode = "SUCCESS = 0\nERROR = 1\nUNKNOWN_ERROR = 2\nVIRTUALENV_NOT_FOUND = 3\nPREVIOUS_BUILD_DIR_ERROR = 4\nNO_MATCHES_FOUND = 23\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pip/_internal/cli/status_codes.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>SUCCESS = 0
ERROR = 1
UNKNOWN_ERROR = 2
VIRTUALENV_NOT_FOUND = 3
PREVIOUS_BUILD_DIR_ERROR = 4
