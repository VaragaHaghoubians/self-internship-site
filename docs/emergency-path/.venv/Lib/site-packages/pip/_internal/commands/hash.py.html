...
<html lang="en">
  <head>
    ...
    <title>Hash.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_internal/commands/hash.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>import hashlib
import logging
import sys
from optparse import Values
