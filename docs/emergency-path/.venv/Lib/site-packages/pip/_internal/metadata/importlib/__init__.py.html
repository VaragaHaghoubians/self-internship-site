...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_internal/metadata/importlib/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from ._dists import Distribution\nfrom ._envs import Environment\n\n__all__ = [\"NAME\", \"Distribution\", \"Environment\"]\n\nNAME = \"importlib\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pip/_internal/metadata/importlib/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ._dists import Distribution
from ._envs import Environment
