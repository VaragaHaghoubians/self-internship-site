...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_internal/models/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"A package that contains models that represent entities.\"\"\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pip/_internal/models/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;A package that contains models that represent entities.&quot;&quot;&quot;
</code></pre></article>
