...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_internal/network/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Contains purely network-related utilities.\"\"\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pip/_internal/network/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Contains purely network-related utilities.&quot;&quot;&quot;
</code></pre></article>
