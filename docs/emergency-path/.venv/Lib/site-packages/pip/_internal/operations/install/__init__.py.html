...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_internal/operations/install/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"For modules related to installing packages.\"\"\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pip/_internal/operations/install/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;For modules related to installing packages.&quot;&quot;&quot;
</code></pre></article>
