...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_internal/resolution/base.py</div>
    </header>
    ...
    <script>
      const readerCode = "from typing import Callable, Optional\n\nfrom pip._internal.req.req_install import InstallRequirement\nfrom pip._internal.req.req_set import RequirementSet\n\nInstallRequirementProvider = Callable[\n    [str, Optional[InstallRequirement]], InstallRequirement\n]\n\n\nclass BaseResolver:\n    def resolve(\n        self, root_reqs: list[InstallRequirement], check_supported_wheels: bool\n    ) -> RequirementSet:\n        raise NotImplementedError()\n\n    def get_installation_order(\n        self, req_set: RequirementSet\n    ) -> list[InstallRequirement]:\n        raise NotImplementedError()\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pip/_internal/resolution/base.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from typing import Callable, Optional
