...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_vendor/distro/__main__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .distro import main\n\nif __name__ == \"__main__\":\n    main()\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pip/_vendor/distro/__main__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .distro import main
