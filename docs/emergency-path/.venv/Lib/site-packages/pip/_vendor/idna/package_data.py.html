...
<html lang="en">
  <head>
    ...
    <title>Package Data.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Package Data.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_vendor/idna/package_data.py</div>
    </header>
    ...
    <script>
      const readerCode = "__version__ = \"3.11\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pip/_vendor/idna/package_data.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__version__ = &quot;3.11&quot;
</code></pre></article>
