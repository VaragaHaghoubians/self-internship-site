...
<html lang="en">
  <head>
    ...
    <title>Uts46Data.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_vendor/idna/uts46data.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># This file is automatically generated by tools/idna-data
# vim: set fileencoding=utf-8 :
