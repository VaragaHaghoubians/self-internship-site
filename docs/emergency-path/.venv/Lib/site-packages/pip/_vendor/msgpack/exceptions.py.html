...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_vendor/msgpack/exceptions.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>class UnpackException(Exception):
    &quot;&quot;&quot;Base class for some exceptions raised while unpacking.
