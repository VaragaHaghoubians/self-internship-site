...
<html lang="en">
  <head>
    ...
    <title> Mapping.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_vendor/pygments/lexers/_mapping.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Automatically generated by scripts/gen_mapfiles.py.
# DO NOT EDIT BY HAND; run `tox -e mapfiles` instead.
