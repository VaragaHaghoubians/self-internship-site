...
<html lang="en">
  <head>
    ...
    <title> Export Format.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1> Export Format.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_vendor/rich/_export_format.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>CONSOLE_HTML_FORMAT = &quot;&quot;&quot;\
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
&lt;meta charset=&quot;UTF-8&quot;&gt;
