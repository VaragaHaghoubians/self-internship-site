...
<html lang="en">
  <head>
    ...
    <title>Themes.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_vendor/rich/themes.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .default_styles import DEFAULT_STYLES\nfrom .theme import Theme\n\n\nDEFAULT = Theme(DEFAULT_STYLES)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pip/_vendor/rich/themes.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .default_styles import DEFAULT_STYLES
from .theme import Theme
