...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_vendor/tomli_w/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "__all__ = (\"dumps\", \"dump\")\n__version__ = \"1.2.0\"  # DO NOT EDIT THIS LINE MANUALLY. LET bump2version UTILITY DO IT\n\nfrom pip._vendor.tomli_w._writer import dump, dumps\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pip/_vendor/tomli_w/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__all__ = (&quot;dumps&quot;, &quot;dump&quot;)
__version__ = &quot;1.2.0&quot;  # DO NOT EDIT THIS LINE MANUALLY. LET bump2version UTILITY DO IT
