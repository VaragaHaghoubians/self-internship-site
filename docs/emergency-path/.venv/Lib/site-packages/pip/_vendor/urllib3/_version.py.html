...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_vendor/urllib3/_version.py</div>
    </header>
    ...
    <script>
      const readerCode = "# This file is protected via CODEOWNERS\n__version__ = \"1.26.20\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pip/_vendor/urllib3/_version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># This file is protected via CODEOWNERS
__version__ = &quot;1.26.20&quot;
</code></pre></article>
