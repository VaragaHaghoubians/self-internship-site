...
<html lang="en">
  <head>
    ...
    <title>Proxy.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_vendor/urllib3/util/proxy.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .ssl_ import create_urllib3_context, resolve_cert_reqs, resolve_ssl_version
