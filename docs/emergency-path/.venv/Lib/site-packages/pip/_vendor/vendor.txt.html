...
<html lang="en">
  <head>
    ...
    <title>Vendor.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pip/_vendor/vendor.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>CacheControl==0.14.4
distlib==0.4.0
distro==1.9.0
msgpack==1.1.2
packaging==26.0
