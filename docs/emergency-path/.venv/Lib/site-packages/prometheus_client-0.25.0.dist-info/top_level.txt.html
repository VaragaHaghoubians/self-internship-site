...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/prometheus_client-0.25.0.dist-info/top_level.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>prometheus_client
</code></pre></article>
