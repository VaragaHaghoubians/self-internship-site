...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/prometheus_client/aiohttp/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .exposition import make_aiohttp_handler\n\n__all__ = [\n    \"make_aiohttp_handler\",\n]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/prometheus_client/aiohttp/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .exposition import make_aiohttp_handler
