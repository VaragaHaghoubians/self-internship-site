...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/prometheus_client/django/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .exposition import PrometheusDjangoView\n\n__all__ = [\n    \"PrometheusDjangoView\",\n]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/prometheus_client/django/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .exposition import PrometheusDjangoView
