...
<html lang="en">
  <head>
    ...
    <title>Platform Collector.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Platform Collector.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/prometheus_client/platform_collector.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>import platform as pf
from typing import Any, Iterable, Optional
