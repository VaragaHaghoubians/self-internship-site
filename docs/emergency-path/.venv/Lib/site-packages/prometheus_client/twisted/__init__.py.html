...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/prometheus_client/twisted/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from ._exposition import MetricsResource\n\n__all__ = ['MetricsResource']\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/prometheus_client/twisted/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ._exposition import MetricsResource
