...
<html lang="en">
  <head>
    ...
    <title> Exposition.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/prometheus_client/twisted/_exposition.py</div>
    </header>
    ...
    <script>
      const readerCode = "from twisted.internet import reactor\nfrom twisted.web.wsgi import WSGIResource\n\nfrom .. import exposition, REGISTRY\n\nMetricsResource = lambda registry=REGISTRY: WSGIResource(\n    reactor, reactor.getThreadPool(), exposition.make_wsgi_app(registry)\n)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/prometheus_client/twisted/_exposition.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from twisted.internet import reactor
from twisted.web.wsgi import WSGIResource
