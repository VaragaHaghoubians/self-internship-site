...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pure_eval/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .core import Evaluator, CannotEval, group_expressions, is_expression_interesting\nfrom .my_getattr_static import getattr_static\n\ntry:\n    from .version import __version__\nexcept ImportError:\n    # version.py is auto-generated with the git tag when building\n    __version__ = \"???\"\n\n__all__ = [\n    \"Evaluator\",\n    \"CannotEval\",\n    \"group_expressions\",\n    \"is_expression_interesting\",\n    \"getattr_static\",\n    \"__version__\",\n]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pure_eval/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .core import Evaluator, CannotEval, group_expressions, is_expression_interesting
from .my_getattr_static import getattr_static
