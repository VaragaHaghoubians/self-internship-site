...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pure_eval/version.py</div>
    </header>
    ...
    <script>
      const readerCode = "__version__ = '0.2.3'";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pure_eval/version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__version__ = &#x27;0.2.3&#x27;</code></pre></article>
