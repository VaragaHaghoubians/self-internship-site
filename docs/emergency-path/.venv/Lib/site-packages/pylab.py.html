...
<html lang="en">
  <head>
    ...
    <title>Pylab.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pylab.py</div>
    </header>
    ...
    <script>
      const readerCode = "from matplotlib.pylab import *  # noqa: F401, F403\nimport matplotlib.pylab\n__doc__ = matplotlib.pylab.__doc__\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pylab.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from matplotlib.pylab import *  # noqa: F401, F403
import matplotlib.pylab
__doc__ = matplotlib.pylab.__doc__
</code></pre></article>
