...
<html lang="en">
  <head>
    ...
    <title>Cursor Base.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Cursor Base.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/pymongo/asynchronous/cursor_base.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Copyright 2026-present MongoDB, Inc.
#
# Licensed under the Apache License, Version 2.0 (the &quot;License&quot;); you
# may not use this file except in compliance with the License.  You
# may obtain a copy of the License at
