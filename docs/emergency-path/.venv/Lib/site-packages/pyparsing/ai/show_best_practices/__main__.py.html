...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pyparsing/ai/show_best_practices/__main__.py</div>
    </header>
    ...
    <script>
      const readerCode = "import pyparsing\npyparsing.show_best_practices()\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/pyparsing/ai/show_best_practices/__main__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>import pyparsing
pyparsing.show_best_practices()
</code></pre></article>
