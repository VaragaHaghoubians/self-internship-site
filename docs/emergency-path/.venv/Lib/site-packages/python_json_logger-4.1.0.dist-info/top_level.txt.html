...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/python_json_logger-4.1.0.dist-info/top_level.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>pythonjsonlogger
</code></pre></article>
