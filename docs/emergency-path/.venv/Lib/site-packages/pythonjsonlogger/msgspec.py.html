...
<html lang="en">
  <head>
    ...
    <title>Msgspec.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pythonjsonlogger/msgspec.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;JSON Formatter using [`msgspec`](https://github.com/jcrist/msgspec)&quot;&quot;&quot;
