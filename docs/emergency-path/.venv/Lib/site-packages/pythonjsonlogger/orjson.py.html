...
<html lang="en">
  <head>
    ...
    <title>Orjson.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/pythonjsonlogger/orjson.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;JSON Formatter using [orjson](https://github.com/ijl/orjson)&quot;&quot;&quot;
