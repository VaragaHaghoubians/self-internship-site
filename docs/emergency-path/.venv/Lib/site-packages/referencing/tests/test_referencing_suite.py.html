...
<html lang="en">
  <head>
    ...
    <title>Test Referencing Suite.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Referencing Suite.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/referencing/tests/test_referencing_suite.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from pathlib import Path
import json
import os
