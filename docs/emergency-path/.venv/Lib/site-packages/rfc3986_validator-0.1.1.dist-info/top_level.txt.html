...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/rfc3986_validator-0.1.1.dist-info/top_level.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>rfc3986_validator
</code></pre></article>
