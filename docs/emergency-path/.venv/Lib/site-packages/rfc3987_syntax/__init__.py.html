...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/rfc3987_syntax/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .syntax_helpers import *\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/rfc3987_syntax/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .syntax_helpers import *
</code></pre></article>
