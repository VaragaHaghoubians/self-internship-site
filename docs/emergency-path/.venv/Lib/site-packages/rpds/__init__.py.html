...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/rpds/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .rpds import *\n\n__doc__ = rpds.__doc__\nif hasattr(rpds, \"__all__\"):\n    __all__ = rpds.__all__";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/rpds/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .rpds import *

__doc__ = rpds.__doc__
if hasattr(rpds, &quot;__all__&quot;):
    __all__ = rpds.__all__</code></pre></article>
