...
<html lang="en">
  <head>
    ...
    <title> Docscrape.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/_lib/_docscrape.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># copied from numpydoc/docscrape.py, commit 97a6026508e0dd5382865672e9563a72cc113bd2
&quot;&quot;&quot;Extract reference documentation from the NumPy source tree.&quot;&quot;&quot;
...
def get_doc_object(
    ...
    if what == &quot;class&quot;:
        ...
        if doc is None:
            doc = pydoc.getdoc(obj)
        return obj_doc(obj, doc, config=config)</code></pre></article>
