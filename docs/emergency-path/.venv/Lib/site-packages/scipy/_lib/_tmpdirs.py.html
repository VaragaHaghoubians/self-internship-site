...
<html lang="en">
  <head>
    ...
    <title> Tmpdirs.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/_lib/_tmpdirs.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&#x27;&#x27;&#x27; Contexts for *with* statement providing temporary directories
&#x27;&#x27;&#x27;
import os
from contextlib import contextmanager
from shutil import rmtree
