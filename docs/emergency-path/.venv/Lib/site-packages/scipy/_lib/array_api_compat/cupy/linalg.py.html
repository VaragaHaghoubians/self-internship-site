...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/_lib/array_api_compat/cupy/linalg.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from cupy.linalg import * # noqa: F403
# cupy.linalg doesn&#x27;t have __all__. If it is added, replace this with
#
# from cupy.linalg import __all__ as linalg_all
_n: dict[str, object] = {}
