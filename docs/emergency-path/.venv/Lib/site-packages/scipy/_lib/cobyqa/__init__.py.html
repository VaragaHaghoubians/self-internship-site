...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/_lib/cobyqa/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .main import minimize\nfrom .utils import show_versions\n\n# PEP0440 compatible formatted version, see:\n# https://www.python.org/dev/peps/pep-0440/\n#\n# Final release markers:\n#   X.Y.0   # For first release after an increment in Y\n#   X.Y.Z   # For bugfix releases\n#\n# Admissible pre-release markers:\n#   X.YaN   # Alpha release\n#   X.YbN   # Beta release\n#   X.YrcN  # Release Candidate\n#\n# Dev branch marker is: 'X.Y.dev' or 'X.Y.devN' where N is an integer.\n# 'X.Y.dev0' is the canonical version of 'X.Y.dev'.\n__version__ = \"1.1.3\"\n\n__all__ = [\"minimize\", \"show_versions\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/scipy/_lib/cobyqa/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .main import minimize
from .utils import show_versions
