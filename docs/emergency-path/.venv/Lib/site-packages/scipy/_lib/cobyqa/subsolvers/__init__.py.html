...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/_lib/cobyqa/subsolvers/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .geometry import cauchy_geometry, spider_geometry\nfrom .optim import (\n    tangential_byrd_omojokun,\n    constrained_tangential_byrd_omojokun,\n    normal_byrd_omojokun,\n)\n\n__all__ = [\n    \"cauchy_geometry\",\n    \"spider_geometry\",\n    \"tangential_byrd_omojokun\",\n    \"constrained_tangential_byrd_omojokun\",\n    \"normal_byrd_omojokun\",\n]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/scipy/_lib/cobyqa/subsolvers/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .geometry import cauchy_geometry, spider_geometry
from .optim import (
    tangential_byrd_omojokun,
    constrained_tangential_byrd_omojokun,
    normal_byrd_omojokun,
