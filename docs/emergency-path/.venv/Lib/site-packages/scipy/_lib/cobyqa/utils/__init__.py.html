...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/_lib/cobyqa/utils/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .exceptions import (\n    MaxEvalError,\n    TargetSuccess,\n    CallbackSuccess,\n    FeasibleSuccess,\n)\nfrom .math import get_arrays_tol, exact_1d_array\nfrom .versions import show_versions\n\n__all__ = [\n    \"MaxEvalError\",\n    \"TargetSuccess\",\n    \"CallbackSuccess\",\n    \"FeasibleSuccess\",\n    \"get_arrays_tol\",\n    \"exact_1d_array\",\n    \"show_versions\",\n]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/scipy/_lib/cobyqa/utils/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .exceptions import (
    MaxEvalError,
    TargetSuccess,
    CallbackSuccess,
    FeasibleSuccess,
