...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/_lib/cobyqa/utils/exceptions.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>class MaxEvalError(Exception):
    &quot;&quot;&quot;
    Exception raised when the maximum number of evaluations is reached.
    &quot;&quot;&quot;
