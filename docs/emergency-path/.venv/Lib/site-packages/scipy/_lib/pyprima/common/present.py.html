...
<html lang="en">
  <head>
    ...
    <title>Present.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/_lib/pyprima/common/present.py</div>
    </header>
    ...
    <script>
      const readerCode = "def present(x):\n    '''\n    This is a Python equivalent of the Fortran 'present' function for optional arguments.\n    '''\n    return x is not None";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/scipy/_lib/pyprima/common/present.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>def present(x):
    &#x27;&#x27;&#x27;
    This is a Python equivalent of the Fortran &#x27;present&#x27; function for optional arguments.
    &#x27;&#x27;&#x27;
    return x is not None</code></pre></article>
