...
<html lang="en">
  <head>
    ...
    <title> Realtransforms Backend.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1> Realtransforms Backend.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/fft/_realtransforms_backend.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from scipy._lib._array_api import array_namespace
import numpy as np
from . import _pocketfft
