...
<html lang="en">
  <head>
    ...
    <title> Ode.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/integrate/_ode.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Authors: Pearu Peterson, Pauli Virtanen, John Travers
&quot;&quot;&quot;
First-order ODE integrators.
