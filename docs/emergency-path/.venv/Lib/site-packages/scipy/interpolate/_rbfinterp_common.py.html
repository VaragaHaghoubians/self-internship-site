...
<html lang="en">
  <head>
    ...
    <title> Rbfinterp Common.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1> Rbfinterp Common.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/interpolate/_rbfinterp_common.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Impl routines common for all backends
from itertools import combinations_with_replacement
from math import comb
