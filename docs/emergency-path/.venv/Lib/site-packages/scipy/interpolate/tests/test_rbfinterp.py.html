...
<html lang="en">
  <head>
    ...
    <title>Test Rbfinterp.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Rbfinterp.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/interpolate/tests/test_rbfinterp.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>import pickle
import pytest
import numpy as np
from numpy.linalg import LinAlgError
from scipy._lib._array_api import xp_assert_close, make_xp_test_case
