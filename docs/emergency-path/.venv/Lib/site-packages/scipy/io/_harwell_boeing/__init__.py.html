...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/io/_harwell_boeing/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .hb import hb_read, hb_write\n\n__all__ = [\"hb_read\", \"hb_write\"]\n\nfrom scipy._lib._testutils import PytestTester\ntest = PytestTester(__name__)\ndel PytestTester\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/scipy/io/_harwell_boeing/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .hb import hb_read, hb_write
