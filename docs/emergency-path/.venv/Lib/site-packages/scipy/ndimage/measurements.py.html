...
<html lang="en">
  <head>
    ...
    <title>Measurements.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Measurements.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/ndimage/measurements.py</div>
    </header>
    ...
    <script>
      ...
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/scipy/ndimage/measurements.py";
