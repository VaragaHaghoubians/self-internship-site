...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/odr/_add_newdocs.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from numpy.lib import add_newdoc
