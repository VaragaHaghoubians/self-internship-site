...
<html lang="en">
  <head>
    ...
    <title> Dual Annealing.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1> Dual Annealing.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/optimize/_dual_annealing.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Dual Annealing implementation.
# Copyright (c) 2018 Sylvain Gubian &lt;sylvain.gubian@pmi.com&gt;,
# Yang Xiang &lt;yang.xiang@pmi.com&gt;
# Author: Sylvain Gubian, Yang Xiang, PMP S.A.
