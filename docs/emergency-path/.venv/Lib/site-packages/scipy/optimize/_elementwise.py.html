...
<html lang="en">
  <head>
    ...
    <title> Elementwise.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1> Elementwise.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/optimize/_elementwise.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from scipy.optimize._bracket import _bracket_root, _bracket_minimum
from scipy.optimize._chandrupatla import _chandrupatla, _chandrupatla_minimize
from scipy._lib._util import _RichResult
from scipy._lib._array_api import xp_capabilities
