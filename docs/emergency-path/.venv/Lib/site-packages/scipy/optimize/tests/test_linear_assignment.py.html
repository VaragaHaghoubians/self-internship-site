...
<html lang="en">
  <head>
    ...
    <title>Test Linear Assignment.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Linear Assignment.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/optimize/tests/test_linear_assignment.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Author: Brian M. Clapper, G. Varoquaux, Lars Buitinck
# License: BSD
