...
<html lang="en">
  <head>
    ...
    <title>Spline.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/signal/spline.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># This file is not meant for public use and will be removed in the future
# versions of SciPy. Use the `scipy.signal` namespace for importing the
# functions included below.
