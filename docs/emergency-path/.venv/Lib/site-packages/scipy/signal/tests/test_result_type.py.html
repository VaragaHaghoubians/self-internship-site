...
<html lang="en">
  <head>
    ...
    <title>Test Result Type.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Result Type.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/signal/tests/test_result_type.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Regressions tests on result types of some signal functions
