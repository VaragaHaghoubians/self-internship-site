...
<html lang="en">
  <head>
    ...
    <title>Cdist X1.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
