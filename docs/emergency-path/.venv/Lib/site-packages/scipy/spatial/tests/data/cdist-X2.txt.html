...
<html lang="en">
  <head>
    ...
    <title>Cdist X2.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
