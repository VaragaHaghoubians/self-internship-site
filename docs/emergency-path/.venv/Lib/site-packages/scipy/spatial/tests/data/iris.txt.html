...
<html lang="en">
  <head>
    ...
    <title>Iris.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/spatial/tests/data/iris.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>5.099999999999999645e+00 3.500000000000000000e+00 1.399999999999999911e+00 2.000000000000000111e-01
