...
<html lang="en">
  <head>
    ...
    <title>Pdist Euclidean Ml Iris.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
