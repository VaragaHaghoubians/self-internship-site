...
<html lang="en">
  <head>
    ...
    <title>Pdist Hamming Ml.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
