...
<html lang="en">
  <head>
    ...
    <title>Pdist Minkowski 3.2 Ml Iris.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
