...
<html lang="en">
  <head>
    ...
    <title>Pdist Minkowski 5.8 Ml Iris.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
