...
<html lang="en">
  <head>
    ...
    <title>Random Double Data.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
