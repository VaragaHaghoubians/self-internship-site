...
<html lang="en">
  <head>
    ...
    <title>Selfdual 4D Polytope.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Selfdual 4D Polytope.Txt</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/spatial/tests/data/selfdual-4d-polytope.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code># The facets of a self-dual 4-dim regular polytope
