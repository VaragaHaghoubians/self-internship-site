...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/special/_sf_error.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Warnings and Exceptions that can be raised by special functions.\"\"\"\nimport warnings\n\n\nclass SpecialFunctionWarning(Warning):\n    \"\"\"Warning that can be emitted by special functions.\"\"\"\n    pass\n\n\nwarnings.simplefilter(\"always\", category=SpecialFunctionWarning)\n\n\nclass SpecialFunctionError(Exception):\n    \"\"\"Exception that can be raised by special functions.\"\"\"\n    pass\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/scipy/special/_sf_error.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Warnings and Exceptions that can be raised by special functions.&quot;&quot;&quot;
import warnings
