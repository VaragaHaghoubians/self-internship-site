...
<html lang="en">
  <head>
    ...
    <title>Test Cdft Asymptotic.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Cdft Asymptotic.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/special/tests/test_cdft_asymptotic.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># gh-14777 regression tests
# Test stdtr and stdtrit with infinite df and large values of df
