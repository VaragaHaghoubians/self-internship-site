...
<html lang="en">
  <head>
    ...
    <title>Test Dd.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/special/tests/test_dd.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># Tests for a few of the &quot;double-double&quot; C++ functions defined in
# special/cephes/dd_real.h. Prior to gh-20390 which translated these
# functions from C to C++, there were test cases for _dd_expm1. It
# was determined that this function is not used anywhere internally
# in SciPy, so this function was not translated.
