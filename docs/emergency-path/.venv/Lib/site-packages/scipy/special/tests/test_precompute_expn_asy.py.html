...
<html lang="en">
  <head>
    ...
    <title>Test Precompute Expn Asy.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Precompute Expn Asy.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/special/tests/test_precompute_expn_asy.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from numpy.testing import assert_equal
