...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/stats/_common.py</div>
    </header>
    ...
    <script>
      const readerCode = "from collections import namedtuple\n\n\nConfidenceInterval = namedtuple(\"ConfidenceInterval\", [\"low\", \"high\"])\nConfidenceInterval. __doc__ = \"Class for confidence intervals.\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/scipy/stats/_common.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from collections import namedtuple
