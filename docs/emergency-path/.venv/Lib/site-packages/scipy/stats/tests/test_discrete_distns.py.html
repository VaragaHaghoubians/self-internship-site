...
<html lang="en">
  <head>
    ...
    <title>Test Discrete Distns.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Discrete Distns.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/scipy/stats/tests/test_discrete_distns.py</div>
    </header>
    ...
    <script>
      ...
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/scipy/stats/tests/test_discrete_distns.py";
