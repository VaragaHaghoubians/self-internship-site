...
<html lang="en">
  <head>
    ...
    <title>Ccompiler.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/_distutils/ccompiler.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .compat.numpy import (  # noqa: F401\n    _default_compilers,\n    compiler_class,\n)\nfrom .compilers.C import base\nfrom .compilers.C.base import (\n    gen_lib_options,\n    gen_preprocess_options,\n    get_default_compiler,\n    new_compiler,\n    show_compilers,\n)\nfrom .compilers.C.errors import CompileError, LinkError\n\n__all__ = [\n    'CompileError',\n    'LinkError',\n    'gen_lib_options',\n    'gen_preprocess_options',\n    'get_default_compiler',\n    'new_compiler',\n    'show_compilers',\n]\n\n\nCCompiler = base.Compiler\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/_distutils/ccompiler.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .compat.numpy import (  # noqa: F401
    _default_compilers,
    compiler_class,
)
from .compilers.C import base
