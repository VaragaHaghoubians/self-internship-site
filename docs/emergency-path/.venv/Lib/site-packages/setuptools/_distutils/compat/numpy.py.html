...
<html lang="en">
  <head>
    ...
    <title>Numpy.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/_distutils/compat/numpy.py</div>
    </header>
    ...
    <script>
      const readerCode = "# required for older numpy versions on Pythons prior to 3.12; see pypa/setuptools#4876\nfrom ..compilers.C.base import _default_compilers, compiler_class  # noqa: F401\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/_distutils/compat/numpy.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># required for older numpy versions on Pythons prior to 3.12; see pypa/setuptools#4876
from ..compilers.C.base import _default_compilers, compiler_class  # noqa: F401
</code></pre></article>
