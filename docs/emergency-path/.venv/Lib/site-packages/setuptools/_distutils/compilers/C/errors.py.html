...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/_distutils/compilers/C/errors.py</div>
    </header>
    ...
    <script>
      const readerCode = "class Error(Exception):\n    \"\"\"Some compile/link operation failed.\"\"\"\n\n\nclass PreprocessError(Error):\n    \"\"\"Failure to preprocess one or more C/C++ files.\"\"\"\n\n\nclass CompileError(Error):\n    \"\"\"Failure to compile one or more C/C++ source files.\"\"\"\n\n\nclass LibError(Error):\n    \"\"\"Failure to create a static library from one or more C/C++ object\n    files.\"\"\"\n\n\nclass LinkError(Error):\n    \"\"\"Failure to link one or more C/C++ object files into an executable\n    or shared library file.\"\"\"\n\n\nclass UnknownFileType(Error):\n    \"\"\"Attempt to process an unknown file type.\"\"\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/_distutils/compilers/C/errors.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>class Error(Exception):
    &quot;&quot;&quot;Some compile/link operation failed.&quot;&quot;&quot;
