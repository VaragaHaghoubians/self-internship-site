...
<html lang="en">
  <head>
    ...
    <title>Test Mingw.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/_distutils/compilers/C/tests/test_mingw.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from distutils import sysconfig
from distutils.errors import DistutilsPlatformError
from distutils.util import is_mingw, split_quoted
