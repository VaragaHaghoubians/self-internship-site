...
<html lang="en">
  <head>
    ...
    <title>Test Log.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/_distutils/tests/test_log.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"Tests for distutils.log\"\"\"\n\nimport logging\nfrom distutils._log import log\n\n\nclass TestLog:\n    def test_non_ascii(self, caplog):\n        caplog.set_level(logging.DEBUG)\n        log.debug('D\u03b5bug\\tM\u0117ss\u00e3ge')\n        log.fatal('F\u03b1tal\\t\u00c8rr\u014dr')\n        assert caplog.messages == ['D\u03b5bug\\tM\u0117ss\u00e3ge', 'F\u03b1tal\\t\u00c8rr\u014dr']\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/_distutils/tests/test_log.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;Tests for distutils.log&quot;&quot;&quot;
