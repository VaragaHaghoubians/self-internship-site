...
<html lang="en">
  <head>
    ...
    <title>Zosccompiler.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Zosccompiler.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/_distutils/zosccompiler.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .compilers.C import zos\n\nzOSCCompiler = zos.Compiler\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/_distutils/zosccompiler.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .compilers.C import zos
