...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/_vendor/autocommand-2.2.2.dist-info/top_level.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>autocommand
</code></pre></article>
