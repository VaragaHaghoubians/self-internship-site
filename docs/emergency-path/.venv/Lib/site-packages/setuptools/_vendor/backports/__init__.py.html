...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/_vendor/backports/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "__path__ = __import__('pkgutil').extend_path(__path__, __name__)  # type: ignore\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/_vendor/backports/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>__path__ = __import__(&#x27;pkgutil&#x27;).extend_path(__path__, __name__)  # type: ignore
</code></pre></article>
