...
<html lang="en">
  <head>
    ...
    <title> Collections.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1> Collections.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/_vendor/importlib_metadata/_collections.py</div>
    </header>
    ...
    <script>
      const readerCode = "import collections\nimport typing\n\n\n# from jaraco.collections 3.3\nclass FreezableDefaultDict(collections.defaultdict):\n    \"\"\"\n    Often it is desirable to prevent the mutation of\n    a default dict after its initial construction, such\n    as to prevent mutation during iteration.\n\n    >>> dd = FreezableDefaultDict(list)\n    >>> dd[0].append('1')\n    >>> dd.freeze()\n    >>> dd[1]\n    []\n    >>> len(dd)\n    1\n    \"\"\"\n\n    def __missing__(self, key):\n        return getattr(self, '_frozen', super().__missing__)(key)\n\n    def freeze(self):\n        self._frozen = lambda key: self.default_factory()\n\n\nclass Pair(typing.NamedTuple):\n    name: str\n    value: str\n\n    @classmethod\n    def parse(cls, text):\n        return cls(*map(str.strip, text.split(\"=\", 1)))\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/_vendor/importlib_metadata/_collections.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>import collections
import typing
