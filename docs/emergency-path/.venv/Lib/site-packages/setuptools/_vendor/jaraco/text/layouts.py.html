...
<html lang="en">
  <head>
    ...
    <title>Layouts.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/_vendor/jaraco/text/layouts.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>qwerty = &quot;-=qwertyuiop[]asdfghjkl;&#x27;zxcvbnm,./_+QWERTYUIOP{}ASDFGHJKL:\&quot;ZXCVBNM&lt;&gt;?&quot;
dvorak = &quot;[]&#x27;,.pyfgcrl/=aoeuidhtns-;qjkxbmwvz{}\&quot;&lt;&gt;PYFGCRL?+AOEUIDHTNS_:QJKXBMWVZ&quot;
