...
<html lang="en">
  <head>
    ...
    <title>Entry Points.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Entry Points.Txt</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/_vendor/wheel-0.46.3.dist-info/entry_points.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>[console_scripts]
