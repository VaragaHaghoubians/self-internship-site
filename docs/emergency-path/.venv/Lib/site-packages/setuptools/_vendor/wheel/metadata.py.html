...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/_vendor/wheel/metadata.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from warnings import warn
