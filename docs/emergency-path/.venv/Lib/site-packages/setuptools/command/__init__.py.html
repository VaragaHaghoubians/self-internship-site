...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/command/__init__.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># mypy: disable_error_code=call-overload
# pyright: reportCallIssue=false, reportArgumentType=false
# Can&#x27;t disable on the exact line because distutils doesn&#x27;t exists on Python 3.12
# and type-checkers aren&#x27;t aware of distutils_hack,
# causing distutils.command.bdist.bdist.format_commands to be Any.
