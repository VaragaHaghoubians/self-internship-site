...
<html lang="en">
  <head>
    ...
    <title>Bdist Rpm.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/command/bdist_rpm.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ..dist import Distribution
from ..warnings import SetuptoolsDeprecationWarning
