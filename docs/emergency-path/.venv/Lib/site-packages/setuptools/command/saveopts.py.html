...
<html lang="en">
  <head>
    ...
    <title>Saveopts.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/command/saveopts.py</div>
    </header>
    ...
    <script>
      const readerCode = "from setuptools.command.setopt import edit_config, option_base\n\n\nclass saveopts(option_base):\n    \"\"\"Save command-line options to a file\"\"\"\n\n    description = \"save supplied options to setup.cfg or other config file\"\n\n    def run(self) -> None:\n        dist = self.distribution\n        settings: dict[str, dict[str, str]] = {}\n\n        for cmd in dist.command_options:\n            if cmd == 'saveopts':\n                continue  # don't save our own options!\n\n            for opt, (src, val) in dist.get_option_dict(cmd).items():\n                if src == \"command line\":\n                    settings.setdefault(cmd, {})[opt] = val\n\n        edit_config(self.filename, settings)\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/command/saveopts.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from setuptools.command.setopt import edit_config, option_base
