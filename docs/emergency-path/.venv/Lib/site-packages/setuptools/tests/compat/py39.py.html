...
<html lang="en">
  <head>
    ...
    <title>Py39.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/tests/compat/py39.py</div>
    </header>
    ...
    <script>
      const readerCode = "from jaraco.test.cpython import from_test_support, try_import\n\nos_helper = try_import('os_helper') or from_test_support('can_symlink')\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/tests/compat/py39.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from jaraco.test.cpython import from_test_support, try_import
