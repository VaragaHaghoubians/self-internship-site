...
<html lang="en">
  <head>
    ...
    <title>Mod With Constant.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Mod With Constant.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/tests/mod_with_constant.py</div>
    </header>
    ...
    <script>
      const readerCode = "value = 'three, sir!'\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/tests/mod_with_constant.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>value = &#x27;three, sir!&#x27;
</code></pre></article>
