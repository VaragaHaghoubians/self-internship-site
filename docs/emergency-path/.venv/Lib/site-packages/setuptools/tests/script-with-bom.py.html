...
<html lang="en">
  <head>
    ...
    <title>Script With Bom.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Script With Bom.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/tests/script-with-bom.py</div>
    </header>
    ...
    <script>
      const readerCode = "result = 'passed'\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/tests/script-with-bom.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>result = &#x27;passed&#x27;
</code></pre></article>
