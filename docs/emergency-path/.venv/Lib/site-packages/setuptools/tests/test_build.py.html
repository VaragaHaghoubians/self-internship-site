...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/tests/test_build.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from setuptools import Command
from setuptools.command.build import build
from setuptools.dist import Distribution
