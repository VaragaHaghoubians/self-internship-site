...
<html lang="en">
  <head>
    ...
    <title>Test Scripts.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Test Scripts.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/tests/test_scripts.py</div>
    </header>
    ...
    <script>
      const readerCode = "from setuptools import _scripts\n\n\nclass TestWindowsScriptWriter:\n    def test_header(self):\n        hdr = _scripts.WindowsScriptWriter.get_header('')\n        assert hdr.startswith('#!')\n        assert hdr.endswith('\\n')\n        hdr = hdr.lstrip('#!')\n        hdr = hdr.rstrip('\\n')\n        # header should not start with an escaped quote\n        assert not hdr.startswith('\\\\\"')\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/tests/test_scripts.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from setuptools import _scripts
