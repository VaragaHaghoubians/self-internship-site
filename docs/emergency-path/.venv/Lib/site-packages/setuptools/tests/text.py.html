...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/tests/text.py</div>
    </header>
    ...
    <script>
      const readerCode = "class Filenames:\n    unicode = 'sm\u00f6rbr\u00f6d.py'\n    latin_1 = unicode.encode('latin-1')\n    utf_8 = unicode.encode('utf-8')\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/tests/text.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>class Filenames:
    unicode = &#x27;smörbröd.py&#x27;
    latin_1 = unicode.encode(&#x27;latin-1&#x27;)
    utf_8 = unicode.encode(&#x27;utf-8&#x27;)
</code></pre></article>
