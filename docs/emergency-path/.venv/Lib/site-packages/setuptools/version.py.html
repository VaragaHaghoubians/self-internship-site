...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/setuptools/version.py</div>
    </header>
    ...
    <script>
      const readerCode = "from ._importlib import metadata\n\ntry:\n    __version__ = metadata.version('setuptools') or '0.dev0+unknown'\nexcept Exception:\n    __version__ = '0.dev0+unknown'\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/setuptools/version.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from ._importlib import metadata
