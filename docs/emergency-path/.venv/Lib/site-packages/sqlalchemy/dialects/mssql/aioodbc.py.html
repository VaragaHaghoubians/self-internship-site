...
<html lang="en">
  <head>
    ...
    <title>Aioodbc.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/sqlalchemy/dialects/mssql/aioodbc.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># dialects/mssql/aioodbc.py
# Copyright (C) 2005-2026 the SQLAlchemy authors and contributors
# &lt;see AUTHORS file&gt;
#
# This module is part of SQLAlchemy and is released under
