...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/sqlalchemy/ext/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "# ext/__init__.py\n# Copyright (C) 2005-2026 the SQLAlchemy authors and contributors\n# <see AUTHORS file>\n#\n# This module is part of SQLAlchemy and is released under\n# the MIT License: https://www.opensource.org/licenses/mit-license.php\n\nfrom .. import util as _sa_util\n\n\n_sa_util.preloaded.import_prefix(\"sqlalchemy.ext\")\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/sqlalchemy/ext/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># ext/__init__.py
# Copyright (C) 2005-2026 the SQLAlchemy authors and contributors
# &lt;see AUTHORS file&gt;
#
# This module is part of SQLAlchemy and is released under
