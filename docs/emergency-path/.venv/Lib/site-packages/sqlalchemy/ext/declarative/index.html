...
<html lang="en">
  <head>
    ...
    <title>declarative - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/sqlalchemy/ext/declarative</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="__init__.py.html"><strong>__init__.py</strong><span>emergency-path/.venv/Lib/site-packages/sqlalchemy/ext/declarative/__init__.py</span></a><a class="dir-item" href="extensions.py.html"><strong>extensions.py</strong><span>emergency-path/.venv/Lib/site-packages/sqlalchemy/ext/declarative/extensions.py</span></a></div></article>
