...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/stack_data/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from .core import Source, FrameInfo, markers_from_ranges, Options, LINE_GAP, Line, Variable, RangeInLine, \\\n    RepeatedFrames, MarkerInLine, style_with_executing_node, BlankLineRange, BlankLines\nfrom .formatting import Formatter\nfrom .serializing import Serializer\n\ntry:\n    from .version import __version__\nexcept ImportError:\n    # version.py is auto-generated with the git tag when building\n    __version__ = \"???\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/stack_data/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from .core import Source, FrameInfo, markers_from_ranges, Options, LINE_GAP, Line, Variable, RangeInLine, \
    RepeatedFrames, MarkerInLine, style_with_executing_node, BlankLineRange, BlankLines
from .formatting import Formatter
from .serializing import Serializer
