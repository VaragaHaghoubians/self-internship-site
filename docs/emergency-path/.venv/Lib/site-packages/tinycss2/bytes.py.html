...
<html lang="en">
  <head>
    ...
    <title>Bytes.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/tinycss2/bytes.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from webencodings import UTF8, decode, lookup
