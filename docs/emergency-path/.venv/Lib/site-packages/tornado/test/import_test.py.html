...
<html lang="en">
  <head>
    ...
    <title>Import Test.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Import Test.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/tornado/test/import_test.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># flake8: noqa
import subprocess
import sys
import unittest
