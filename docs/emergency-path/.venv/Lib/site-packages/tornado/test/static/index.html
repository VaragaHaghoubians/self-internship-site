...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/tornado/test/static</div>
    </header>
    
    <main class="layout">
      <article class="content"><h2>Readable files</h2><p>Choose a file or folder. Markdown is rendered cleanly, and code files are shown in a focused reading view.</p><div class="dir-list"><a class="dir-item" href="robots.txt.html"><strong>robots.txt</strong><span>emergency-path/.venv/Lib/site-packages/tornado/test/static/robots.txt</span></a></div></article>
