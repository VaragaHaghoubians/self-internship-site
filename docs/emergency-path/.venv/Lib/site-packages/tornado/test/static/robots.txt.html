...
<html lang="en">
  <head>
    ...
    <title>Robots.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/tornado/test/static/robots.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>User-agent: *
Disallow: /
</code></pre></article>
