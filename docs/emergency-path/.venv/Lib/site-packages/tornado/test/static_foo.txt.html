...
<html lang="en">
  <head>
    ...
    <title>Static Foo.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Static Foo.Txt</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/tornado/test/static_foo.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>This file should not be served by StaticFileHandler even though
