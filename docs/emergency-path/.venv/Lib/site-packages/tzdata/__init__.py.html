...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/tzdata/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "# IANA versions like 2020a are not valid PEP 440 identifiers; the recommended\n# way to translate the version is to use YYYY.n where `n` is a 0-based index.\n__version__ = \"2026.1\"\n\n# This exposes the original IANA version number.\nIANA_VERSION = \"2026a\"\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/tzdata/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code># IANA versions like 2020a are not valid PEP 440 identifiers; the recommended
# way to translate the version is to use YYYY.n where `n` is a 0-based index.
__version__ = &quot;2026.1&quot;
