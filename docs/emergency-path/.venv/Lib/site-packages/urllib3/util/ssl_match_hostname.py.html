...
<html lang="en">
  <head>
    ...
    <title>Ssl Match Hostname.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      <h1>Ssl Match Hostname.Py</h1>
      <p>Clean code reading view for studying, copying, and comparing your own implementation.</p>
      <div class="path">emergency-path/.venv/Lib/site-packages/urllib3/util/ssl_match_hostname.py</div>
    </header>
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;The match_hostname() function from Python 3.5, essential when using SSL.&quot;&quot;&quot;
