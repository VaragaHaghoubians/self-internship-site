...
<html lang="en">
  <head>
    ...
    <title>Metadata.Json - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
