...
<html lang="en">
  <head>
    ...
    <title>Header03.Txt - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/websocket/tests/data/header03.txt</div>
    </header>
    
    <main class="layout">
      <article class="content"><pre><code>HTTP/1.1 101 WebSocket Protocol Handshake
