...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/zmq/backend/cffi/README.md</div>
    </header>
    
    <main class="layout">
      <article class="content"><p>PyZMQ&#x27;s CFFI support is designed only for (Unix) systems conforming to <code>have_sys_un_h = True</code>.</p></article>
