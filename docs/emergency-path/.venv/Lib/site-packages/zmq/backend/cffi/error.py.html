...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/zmq/backend/cffi/error.py</div>
    </header>
    ...
    <script>
      const readerCode = "\"\"\"zmq error functions\"\"\"\n\n# Copyright (C) PyZMQ Developers\n# Distributed under the terms of the Modified BSD License.\n\nfrom ._cffi import ffi\nfrom ._cffi import lib as C\n\n\ndef strerror(errno):\n    return ffi.string(C.zmq_strerror(errno)).decode()\n\n\nzmq_errno = C.zmq_errno\n\n__all__ = ['strerror', 'zmq_errno']\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/zmq/backend/cffi/error.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>&quot;&quot;&quot;zmq error functions&quot;&quot;&quot;
