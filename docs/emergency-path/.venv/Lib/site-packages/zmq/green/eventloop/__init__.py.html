...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/zmq/green/eventloop/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from zmq.green.eventloop.ioloop import IOLoop\n\n__all__ = ['IOLoop']\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/zmq/green/eventloop/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from zmq.green.eventloop.ioloop import IOLoop
