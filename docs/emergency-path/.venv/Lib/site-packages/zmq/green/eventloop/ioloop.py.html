...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/zmq/green/eventloop/ioloop.py</div>
    </header>
    ...
    <script>
      const readerCode = "from zmq.eventloop.ioloop import *  # noqa\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/zmq/green/eventloop/ioloop.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from zmq.eventloop.ioloop import *  # noqa
</code></pre></article>
