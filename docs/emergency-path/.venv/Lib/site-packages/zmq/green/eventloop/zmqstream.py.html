...
<html lang="en">
  <head>
    ...
    <title>Zmqstream.Py - Self-Internship Reader</title>
    <style>
      :root {
        --bg: #f7f5ef;
        --surface: #fffdf8;
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/zmq/green/eventloop/zmqstream.py</div>
    </header>
    ...
    <script>
      const readerCode = "from zmq.eventloop import zmqstream\nfrom zmq.green.eventloop.ioloop import IOLoop\n\n\nclass ZMQStream(zmqstream.ZMQStream):\n    def __init__(self, socket, io_loop=None):\n        io_loop = io_loop or IOLoop.instance()\n        super().__init__(socket, io_loop=io_loop)\n\n\n__all__ = [\"ZMQStream\"]\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/zmq/green/eventloop/zmqstream.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from zmq.eventloop import zmqstream
from zmq.green.eventloop.ioloop import IOLoop
