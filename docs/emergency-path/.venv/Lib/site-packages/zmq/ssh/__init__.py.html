...
<html lang="en">
  ...
  <body>
    ...
    <header class="hero">
      ...
      <div class="path">emergency-path/.venv/Lib/site-packages/zmq/ssh/__init__.py</div>
    </header>
    ...
    <script>
      const readerCode = "from zmq.ssh.tunnel import *\n";
      const readerOutputKey = "readerRun:emergency-path/.venv/Lib/site-packages/zmq/ssh/__init__.py";
...
`;
    ...
    <main class="layout">
      <article class="content"><pre><code>from zmq.ssh.tunnel import *
</code></pre></article>
